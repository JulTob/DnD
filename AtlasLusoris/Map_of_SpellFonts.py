"""
Map_of_SpellFonts — which face each class's spellcasting section title wears.

A lookup, not a Tag: this is presentation flavor (which font a class's header
renders in), not a domain axis a Character composes onto its identity — so it
stays a plain key -> value record, the same shape as every other Map_of_X in
this Atlas. Add a class here to give it its own voice; nothing else changes.
...
if __name__ == "__main__":
	...
	print("Map_of_SpellFonts: self-test passed.")
