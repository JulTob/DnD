...
f"You gain the **{subtype}** sorcerous origin; see PHB ’24 pp145-150.", "Class: Sorcerer"),
		...
		# ---------- LEVEL 5 -----------------------------------------------
		if lvl >= 5:
			feats.append(Feature("Sorcerous Restoration",
"""
...
""", "Class: Sorcerer"))
		...
		# ---------- LEVEL 7 -----------------------------------------------
		if lvl >= 7:
			feats.append(Feature("Sorcery Incarnate",
"""
...
""", "Class: Sorcerer"))
		...
		if lvl >= 20:
			feats.append(Feature("Arcane Apotheosis",
"""
