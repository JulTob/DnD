"""Grimoire_of_NPC — temporarily loaded from vaulted bytecode (recovery 2026-08-29)."""
...
_PYC = Path(__file__).resolve().parents[2] / ".recovery-vault" / "alusoris" / "Grimoire_of_NPC.cpython-314.pyc"

_body_name = "AtlasActorLudi.AtlasAlusoris._bc_Grimoire_of_NPC"
