"""Map_of_NonPlayer_Features — temporarily loaded from vaulted bytecode (recovery 2026-08-29)."""
...
_PYC = Path(__file__).resolve().parents[2] / ".recovery-vault" / "alusoris" / "Map_of_NonPlayer_Features.cpython-314.pyc"

_body_name = "AtlasActorLudi.AtlasAlusoris._bc_Map_of_NonPlayer_Features"
