...
Membership stays transactional on the Species / Heritage Tag.
These Imprints write the sheet fields (species, heritage, size, speed)
once that membership is already decided.
"""
...
def Imprint_Species(
	...
	current_type = Current_Creature_Type(
		target,
		)
