...
def _project_nimbleness(
	...
	Project_Species_Feature(
		...
		"Halfling Nimbleness",
		(
			"*This is just like child's play. Try not to get caught. "
			"You may die.*\n\n"
			"You can move through the space of any creature that is at least "
			"one size larger than you, though you can't stop there."
			),
		chips=(
			(
				"Creature Passage",
...
def _project_luck(
	...
	Project_Species_Feature(
		...
		"Luck",
		(
			"*Halflings are said to be the luckiest people alive. "
			"You hope so.*\n\n"
...
def _project_natural_stealth(
	...
	Project_Species_Feature(
		...
		"Naturally Stealthy",
		(
			"*You read in your stories that halflings can become invisible. "
			"You often wish it were true.*\n\n"
