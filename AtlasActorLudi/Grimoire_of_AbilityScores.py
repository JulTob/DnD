...
class AbilityScores:
	...
	def __init__(AS, STR=10, DEX=10, CON=10, INT=10, WIS=10, CHA=10, character=None):
		...
		AS.WIS = WIS
		AS.CHA = CHA
		# QST-0016.2 threading, completed to the suite's contract: the owner
		# rides along so score draws can reach the character's own Dice Bags.
