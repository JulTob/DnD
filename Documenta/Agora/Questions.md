...
| Q-0035 | Which of the Paladin's oath lines stay, go or are rewritten, and how does an oath avoid echoing itself or another Oath? (QST-0127) | Julio | Lorekeeper (Elf Sage), Venustas (Bard), Contracts (Warlock), Simplicity (Monk) | `Dialogs/0026-paladin-oath-lines-review.md` | 🟡 framed, deliberation pending |
