"""Charts_of_Scene_Binder — temporarily loaded from vaulted bytecode (recovery 2026-08-29)."""
...
_PYC = Path(__file__).resolve().parents[1] / ".recovery-vault" / "AtlasMagistratum" / "Charts_of_Scene_Binder.cpython-314.pyc"

_body_name = "AtlasMagistratum._bc_Charts_of_Scene_Binder"
