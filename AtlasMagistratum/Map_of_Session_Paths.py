"""Map_of_Session_Paths — temporarily loaded from vaulted bytecode (recovery 2026-08-29)."""
...
_PYC = Path(__file__).resolve().parents[1] / ".recovery-vault" / "AtlasMagistratum" / "Map_of_Session_Paths.cpython-314.pyc"

_body_name = "AtlasMagistratum._bc_Map_of_Session_Paths"
