...
def Title():
    ...
    rank = [
        ...
        "Zenithar",
        "Brahmin","Bane",
        "Brigadier","Bishop","Blight",
        "Cadet","Canon","Cardinal",
        "Captain", "Centurion","Chieftain","Cleric",
        ...
        "Heart of Eldorado",
        "High Priest",
        "Illusionist","Immortal","Infernal","Invoker",
        "Lama","Lecturer","Legate","Librarian","Lieutenant",
        "Lost Conquistador of Eldorado",
        "Major","Marshal","Matriarch","Mogul","Monk",
        "Nun","Ninja",
        "Patriarch","Pharaoh","Professor","Pasha","Prelate","Priestess",
        "Raj","Reader",
        "Samurai","Scholar","Sergeant","Shaman",
        "Tutor","Tribe Leader",
        "Vicar",
        "Warlord",  
...
def Racial_Names(Type):
    ...
    Human_Surnames = [
        ...
        "Sum", "Tan", "Wan", "Agosto", "Astorio", "Calabra", "Domine", "Falone",
        "Marivaldi", "Pisacar", "Ramondo", "Picasso", "Blackbeast", "Blackbeard",
        "Blackbear", "Violetdawn", "Rosedawn", "Wanderlust", "Dostoyevsky", "Dundragon",
        "Pendragon",
        "Clawthorne"
        ]
    if Type == "Human":
    ...
    Elves =[
        "Aegnor",    "Ael",    "Aelar",    "Aeol",    "Aerandir",    "Aeris",
        "Aero", "Adalara", "Adalin", "Adran", "Adrie", "Ag", "Alador",
        "Alagos", "Alathaea", "Aldovale", "Alima", "Alorio", "Althaea",
        "Althos", "Amastacia", "Amelia", "Amity", "Anali", "Anakin", 
        "Andraste", "Ang", "Angorn", "Angrod", "Annon", "Anastriana",
        "Antinua", "Anthon", "Ara", "Aramil", "Aranel", "Aranis", "Araphor",
        "Arathorn", "Aratlion", "Arondir", "Arthern", "Arannis", "Arn", "Aro",
        "Arphor", "Arros", "Arthalion", "Arthriol", "Asur", 
        "Astrid", "Athos", "Atro", "Aubren", "Aust", "Austio",
        "Autumnfall", "Ava", "Avafi", "Azaki", "Austio", "Austarion", "Autumn",
        "Baldric", "Banderliss", "Bark", "Barathor", "Basha", "Bella", "Belladonna",
        "Beren", "Bertin", "Birel", "Birel", "Bleonal",
        "Blim", "Blorin", "Bodil", "Bor", "Borivik", "Boromir",
        "Bral", "Brannon", "Brath", "Brithiel", "Brodin", "Broe", "Brom",
        "Bryn", "Brueral", "Byrius", "Cael", "Caelin", "Caelum", "Caladwen",
        "Caran", "Carric", "Caspian",
        "Celtana", "Certhel",
        "Celeborn", "Celebrian", "Celebriel", "Celebrimbor",
        "Certhel", "Chel", "Chelri",
        "Cirdan", "Clagna", "Claira", "Cothiel",
        "Curufin", "Curulire", "Cuthalion",
        "Daeron", "Dalanzal", "Danel", "Dartagnan",
        "Dawnpath", "Del", "Delian", "Deloth", 
        "Denethor", "Denir", "Dilon", "Dinendal",
        "Dineloth", "Donael", "Donathan", "Dor", "Dorin", "Dorn", "Douglas", "Draven", "Driel",
        "Drusilia", "Durin", "Durgwen",
        "Earendil", "Eariol", "Earwen", "Eda", "Edalin",
        "Edan", "Edrial", "Edriol", "Eero", "Egorn", 
        "Eilinora", "Eilri", "Eiro", "Elandrial", "Elanor",
        "Ela", "Elenia", "Eleonor", "Elendil", "Elendithas", "Elennanor", "Elenwe", 
        "Elestirne", "Elessar", "Elhalyn", "Elion", "Elmo", "Elphir", "Elriol",
        "Elrond", "Elros", "Elrohir", "Elu", "Elwen", "Elwing",
        "Elion", "Eli", "Elian", "Elior",
        "Elinor", "Elwe", "Elyan",
        "Elerian", "Elthorin", "Elerossë", "Elphir", "Elvandar", "Eol", 
        "Eolande", "Eoliel", "Eoloriel", "Eorl", "Ephelion", "Erevan",
        "Eriol", "Erin", "Ermo", "Ero", "Erol", "Eru", "Erwen", "Eryn",
        "Ethalion", "Ethir", "Faelir", "Fae", "Faen", "Fael", "Faelon",
        "Faenor", "Fara", "Farin", "Faral", "Felosial", "Fen", "Fera",
        "Ferumbras",
        "Feantur",
        "Feanor",
        "Aelthion",
        ...
        "Berrian", "Betha", "Bertin", "Birel", "Birel", "Blath", "Blein",
        ...
        "Sylv", "Tauriel", "Thia", "Thranduil", "Tindecet", "Tris",
        "Trian", "Valance", "Vadan", "Valna",
        "Vanimial", "Vall", "Van", "Vanes", "Vax", "Vaxeldan",
        "Vex", "Vexhalia", "Viasta", "Wasanzi",
        "Wil", "Wenion", "Xanapia", "Xyrkraken", "Xylia", "Yael",
        "Yaeldrin", "Yesstina", "Zamior", "Zarivol",
        "Zay", "Zelaerys", "Zelir",
        "Zeren", "Zia", "Zorro"
        ]
    ...
    ElvenSurnames = [
        ...
        "Windrunner",
        "Moonbeam", 
        "Skydancer", "Glimmerwing", "Sunglow",
        "Thornheart", "Lightbearer", "Twilightveil", 
        ...
        "Nightglow", "Starflight", "Rainshadow", 
        "Goldenleaf", "Whisperbreeze", "Moonlace",
        "Dewshine", "Twilightbloom", "Moonstone", 
        ...
        "Emeraldshade", "Crystalbrook", "Silverstream",
        "Starbright", "Moonsinger", "Twilightleaf",
        "Sunburst", "Dreamlight", "Whispershade",
        "Glimmerleaf", "Silentmoon", "Shadowvale", 
        "Dawnlight", "Glimmershade", "Goldendew",
        "Nightstar", "Twilightmist",
        "Eldar",
        "Moonchild",
        "Sunweaver",
        "Starcaller",
    ...
    Orcs =[
        ...
        "Agmund", "Alrek", "Bjarte", "Brondar", "Dagfinn", "Einar", "Eyvind", "Frode",
        "Geirmund",
        "Gunnar",
        "Halvard", "Harald", "Inge", "Ivar", "Jarl", "Ketil", "Knute", "Leif", "Magnar",
        "Oddr", "Ormr", "Ragnarr", "Rolf", "Sigurd", "Skarde", "Snorri", "Sorli",
        "Steinar", 
        "Thrainn", "Ulf", "Valgard", "Vidar", "Yngvar", "Orm", "Hakon", "Bragi", "Toste", "Trygg"
    ...
    OrcSurnames = [
        ...
        "Thoralsson", "Olofsson", "Aldisson", "Herdisson",
        "Ingrisson", "Skusson", "Svasson",
        "Ensson", "Vifsson", "Iulisson", "Sveinsson",
        "Throlaksson", "Jorsson",
        "Ballisson",
        "Yorksson", "Yurksson",
        "Ereksson", "Eriksson",
        ...
        "Warblade", "Goreaxe", "Frostmaul", "Darkfury", 
        "Stormblade", "Earthshaker",
        "Firefist", "Blooddrinker", "Ragefury",
        "Warsong", 
        "Battlerager",
        "Goreclaw", "Steelbite",
        "Bladestorm", "Skullsplitter", "Maulfist", 
        "Bloodscream", "Stormfist",
        "Firemaul", "Shadowclaw", "Thundermaul",
        "Warfang", 
        "Ironmaul", "Bonecrusher",
        "Rageblade", "Battleshout", "Goremaul",
        "Thunderaxe", 
        "Stormrend",
        ...
        "Skullcrusher", "Shadowbreaker", "Ironfury",
        "Bloodfury", 
        "Ragesong",
        "Battleclaw", "Warmaul",
        "Bladebreaker", "Stormfury", "Firethorn", 
        "Shadowrend", "Thunderblade",
        "Gorebreaker", "Ironblade", "Bloodmaul",
        "Battlerage"
        ]
    if Type == "Orc":
        Names += Orcs
    ...
    Dwarves = [
        ...
        "Blanca", "Ignacio", "Gonzalo", "Rafael", "Igon",
        "Marian", "Aurelio", "Alfredo",
        "Ramon", "Ramona", "Eulario", "Paca", "Francisca",
        "Paco", "Francisco", "Antonio",
        "Leonor", "Juanes", "Juliana", "Ramono", "Angela",
        "Arturo", "Leandro", "Cornelio",
        "Feliz", "Jose", "Josejuan", "Joseramon", "Josealberto",
        "Josenrique", "Joseantonio",
        "Lucia", "Diego", "Armando", "Samuel", "Enrique", "Antonio",
        "Miguel", "Bernardo", "Alberto",
        "Adelaida", "Adelita", "Adora", "Adrian", "Agustin",
        "Agustina", "Ainara", "Ainoa",
        "Aitana", "Aitor", "Alba", "Alejandra", "Alejandro",
        "Alejo", "Alex", "Alfonso", "Alfredo",
        "Almudena", "Alonso", "Alvaro", "Amadeo",
        "Amancio", "Amaya", "Ambrosio", "Amparo",
        "Belen", "Anacleto", "Isabel", "Maria",
        "Sofia", "Angustias", "Anibal", "Anselmo",
        "Antonio", "Apolonio", "Araceli", "Armando",
        "Aroa", "Arsenio", "Arturo", "Ascensión",
        "Asunción", "Atanasio", "Atilio", "Aureliano",
        "Aurelio", "Avelina", "Azucena", "Baldomero",
        "Bárbara", "Bartolomé", "Basilio", "Beatriz",
        "Begoña", "Benita", "Bermudo", "Bernarda",
        "Borja", "Brigida", "Calisto", "Camila",
        "Candelaria", "Candida", "Carlos", "Carlota",
        "Carmela", "Carmelo", "Casilda", "Casimiro",
        "Catalina", "Cecili", "Celeste", "Celestino",
        "Celino", "Chema", "Clara", "Clarisa",
        "Claudia", "Claudio", "Clemente", "Cleto",
        "Constantino", "Consuela", "Corina", "Cornelio",
        "Cosmo", "Cristian", "Cristina", "Cristobal",
        "Curro", "Custodia", "Custodio", "Dagoberto",
        "Damian", "Daniel", "Daniela", "Danilo",
        "Dariel", "Darío", "Debora", "Demetrio",
        "Desideria", "Desiderio", "Diego", "Domingo",
        "Domitilda", "Eberardo", "Edelmira", "Edmundo",
        "Eduardo", "Eladio", "Eleuterio", "Eligio", "Elisa",
        "Eliseo", "Elodia", "Emigdia",
        "Emiliano", "Emilio", "Encarnación", "Enriqueta",
        ...
        "Fulgencio", "Gabriel", "Geraldo", "Gilberta",
        "Godofredo", "Gonzalo", "Gregoria",
        "Gregorio", "Grimaldo", "Guadalupe", "Guillermo",
        "Haroldo", "Hector", "Herminia",
        "Hernando", "Hortensia", "Humberto", "Iban",
        "Ignacia", "Ignacio", "Inés", "Iñigo",
        "Inmaculada", "Inocencio", "Isidora", "Isidoro",
        "Jacinta", "Jacinto", "Jeremías",
        "Jerónimo", "Jesusa", "Jimeno", "Jimena",
        "Jorge", "Jose", "Joseangel", "Joseantonio",
        "Josefa", "Joseluis", "Josemanuel", "Josemari",
        "Josemaria", "Juan", "Juana", "Juancho",
        "Juancarlos", "Juanfran", "Juanita", "Juanjosé",
        "Juanma", "Juanpablo", "Justina",
        "Justino", "Justo", "Kiko", "Laura", "Lázaro",
        "Leandro", "Lope", "Lucas", "Lucrecio",
        "Lucrecia", "Luisa", "Manolo", "Manola",
        "Manuel", "Marcelo", "Marcela", "Marcos",
        "Margarita", "Maribel", "Mario", "Marta",
        "Martín", "Mateo", "Mauro", "Melania",
        "Mercedes", "Ignacio", "Natalio", "Nicodemo",
        "Nieves", "Norberto", "Octavia",
        "Octavio", "Olegario", "Pascual", "Pascuala",
        "Patricia", "Patricio", "Patrocinia",
        "Patrocinio", "Paulino", "Pedro", "Pelayo",
        "Placido", "Placida", "Prospero", "Raimundo",
        "Ramón", "Raúl", "Remedios", "Ricardo", "Roberta", "Robertina", "Roberto", "Rocío",
    ...
    Tieflings = [
        ...
        "Hate-ill", "Burton",
        "Forsaken",
        "Williams", "Virtue", "Shepard",
        "Amynus",
        "Smen",
        "Apronadius", "Abdamelek", "Xonsu",
        "Aziza", "Ramla", "Neema", "Cleopatra",
        ...
        "Azael", "Azazel",
        "Baal", "Bael", "Balam", "Baphomet",
        "Bafomet",
        "Barbiel", "Barbuel", "Barmiel",
        "Baruchas",
        "Bathin", "Barbatos", "Beelxebub",
        "Belzebub",
        "Satan", "Ornias", "Nicodemus",
        "Behemoth",
        "Lucifer", "Madilon", "Solymo",
        "Saroy",
        "Zeu",
        "Ameclo",
        "Sagrael",
        ...
        "Onoskelis", "Orias", "Ornias", "Orobas", "Ose",
