...
def Language(race=Race(), background=Background()):
    ...
    if race == "Aberration":
        if not ("Deep Speech" in l):
            l += "Deep Speech. "
        if Dice() == 1 and not ("Undercommon" in l):
            l += "Undercommon. "
        if Dice(20) == 1 and not ("Telepathy" in l):
            l += "Telepathy. "

    if race == "Aven":
        if not ("Common" in l):
            l += "Common. "
        if Dice(10) == 1 and not ("Primordial" in l):
            l += "Primordial. "
    ...
    if race == "Celestial":
        if not ("Celestial" in l):
            l += "Celestial. "
        if not ("Common" in l):
            l += "Common. "
        if Dice() == 1 and not ("Sylvan" in l):
            l += "Sylvan. "
        if Dice(20) == 1 and not ("All languages" in l):
            l += "All languages. "
        if Dice(20) == 1 and not ("Telepathy" in l):
            l += "Telepathy. "
    ...
    if race == "Dragon":
        l += "Draconic. "
        if Dice(3) == 1 and not ("Common" in l):
            l += "Common. "
        if Dice() == 1 and not ("Sylvan" in l):
            l += "Sylvan. "
        if Dice(8) == 1 and not ("Dwarvish" in l):
            l += "Dwarvish. "
        if Dice(8) == 1 and not ("Elvish" in l):
            l += "Elvish. "
        if Dice(8) == 1 and not ("Orc" in l):
            l += "Orc. "
        if Dice(8) == 1 and not ("Goblin" in l):
            l += "Goblin. "
    ...
    if race == "Dwarf":
        ...
        if Dice(3) == 1 and not ("Common" in l):
            l += "Common. "
        if Dice(3) == 1 and not ("Undercommon" in l):
            l += "Undercommon. "
    ...
    if race == "Elf":
        ...
        if Dice(3) == 1 and not ("Common" in l):
            l += "Common. "
        if Dice(3) == 1 and not ("Sylvan" in l):
            l += "Sylvan. "

    if race == "Elemental":
        l += "Primordial. "
        if Dice() == 1 and not ("Common" in l):
            l += "Common. "
        if Dice(4) == 1:
            l += "Ignan. "
        if Dice(4) == 1:
    ...
    if race == "Fey":
        ...
        if Dice(3) == 1 and not ("Common" in l):
            l += "Common. "
        if Dice(3) == 1 and not ("Elvish" in l):
            l += "Elvish. "

    if race == "Fiend":
        if not ("Common" in l):
            l += "Common. "
        if Dice(2) == 1 and not ("Infernal" in l):
            l += "Infernal. "
        if Dice(2) == 1 and not ("Abyssal" in l):
            l += "Abyssal. "
        if Dice(10) == 1 and not ("Telepathy" in l):
            l += "Telepathy. "
    ...
    if race == "Goblin":
        if not ("Goblin" in l):
            l += "Goblin. "
        if Dice(2) == 1 and not ("Common" in l):
            l += "Common. "
        if Dice() == 1 and not ("Giant" in l):
            l += "Giant. "
        if Dice(10) == 1 and not ("Draconic" in l):
            l += "Draconic. "

    if race == "Halfling":
        if not ("Common" in l):
            l += "Common."
        if not ("Halfling" in l):
            l += "Halfling. "
    if race == "Kobold":
        l += "Draconic. "
        if Dice(3) == 1 and not ("Common" in l):
    ...
    if race == "Undead":
        ...
        if Dice(2) == 1 and not ("Common" in l):
            l += "Common. "
        if Dice(8) == 1 and not ("Infernal" in l):
            l += "Infernal. "
        if Dice(8) == 1 and not ("Abyssal" in l):
            l += "Abyssal. "
        if Dice(8) == 1 and not ("Celestial" in l):
            l += "Celestial. "

    if background == "Druid":
        l += "Druidic. "
        if Dice(4) == 1 and not ("Sylvan" in l):
            l += "Sylvan. "
        if Dice(4) == 1 and not ("Primordial" in l):
            l += "Primordial. "
        if Dice(4) == 1 and not ("Draconic" in l):
            l += "Draconic. "
        if Dice(4) == 1 and not ("Elvish" in l):
            l += "Elvish. "
    ...
    if background == "Cultist":
        ...
        if Dice(8) == 1 and not ("Celestial" in l):
            l += "Celestial. "
        if Dice(8) == 1 and not ("Draconic" in l):
            l += "Draconic. "
        if Dice(8) == 1 and not ("Deep Speech" in l):
            l += "Deep Speech. "
        if Dice(8) == 1 and not ("Infernal" in l):
            l += "Infernal. "
        if Dice(8) == 1 and not ("Primordial" in l):
            l += "Primordial. "
        if Dice(8) == 1 and not ("Sylvan" in l):
            l += "Sylvan. "
        if Dice(8) == 1 and not ("Undercommon" in l):
            l += "Undercommon. "
    ...
    if background == "Explorer":
        if Dice(4) == 1 and not ("Elvish" in l):
            l += "Elvish. "
        if Dice(4) == 1 and not ("Giant" in l):
            l += "Giant. "
        if Dice(4) == 1 and not ("Goblin" in l):
            l += "Goblin. "
        if Dice(4) == 1 and not ("Orc" in l):
            l += "Orc. "
        if Dice() == 1 and not ("Draconic" in l):
            l += "Draconic. "
        if Dice() == 1 and not ("Primordial" in l):
            l += "Primordial. "
        if Dice() == 1 and not ("Sylvan" in l):
            l += "Sylvan. "
    ...
    if background == "Priest":
        ...
        if Dice() == 1 and not ("Celestial" in l):
            l += "Celestial. "
        if Dice() == 1 and not ("Infernal" in l):
            l += "Infernal. "
        if Dice() == 1 and not ("Abyssal" in l):
            l += "Abyssal. "
    ...
    if background == "Scholar":
        ...
        if Dice() == 1 and not ("Draconic" in l):
            l += "Draconic. "
        if Dice() == 1 and not ("Deep Speech" in l):
            l += "Deep Speech. "
        if Dice() == 1 and not ("Infernal" in l):
            l += "Infernal. "
        if Dice() == 1 and not ("Primordial" in l):
...
def Magic(Lvl, race=Race(), background=Background()):
    ...
    for L in range(int(1+Lvl)):
        ...
        if background == "Cultist" and Dice(3) == 1 and not ("Light" in cantrip):
            cantrip += "\n- Light."
        if background == "Cultist" and Dice(3) == 1 and not ("Sacred flame" in cantrip):
            cantrip += "\n- Sacred flame"
        if background == "Cultist" and Dice(3) == 1 and not ("Thaumaturgy" in cantrip):
            cantrip += "\n- Thaumaturgy"
        ...
        if background == "Mage" and Dice(2) == 1 and not ("Firebolt" in cantrip):
            cantrip += "\n - Firebolt"
        if background == "Mage" and Dice(2) == 1 and not ("Light" in cantrip):
            cantrip += "\n - Light"
        if background == "Mage" and Dice(2) == 1 and not ("Sleep" in first):
            first += "\n - Sleep"
            slots1 += Dice(2)

        if background == "Monk" and Dice(2) == 1 and not ("Mage Hand" in cantrip):
            cantrip += "\n- Mage Hand"
        if background == "Monk" and Dice(2) == 1 and not ("Feather Fall" in three):
            three += "\n- Feather Fall"
        if background == "Monk" and Dice(2) == 1 and not ("Jump" in three):
            three += "\n- Jump"
        if background == "Monk" and Dice(2) == 1 and not ("See Invisibility" in three):
            three += "\n- See Invisibility"
        if background == "Monk" and Dice(2) == 1 and not ("Shield" in three):
            three += "\n- Shield"
        if background == "Monk" and Dice(2) == 1 and not ("Misty Step" in three):
            three += "\n- Misty Step"
        if background == "Monk" and Dice(2) == 1 and not ("Nondetection" in three):
            three += "\n- Nondetection, self Only."

        if background == "Priest" and Dice(2) == 1 and not ("Light" in cantrip):
            cantrip += "\n- Light. "
        if background == "Priest" and Dice(2) == 1 and not ("Sacred flame" in cantrip):
            cantrip += "\n- Sacred flame. "
        if background == "Priest" and Dice(2) == 1 and not ("Thaumaturgy" in cantrip):
            cantrip += "\n- Thaumaturgy"
        if background == "Priest" and Dice() == 1 and not ("Guidance" in cantrip):
            cantrip += "\n- Guidance"
        if background == "Priest" and Dice() == 1 and not ("Resistance" in cantrip):
            cantrip += "\n- Resistance"
        ...
        if background == "Shaman" and Dice() == 1 and not ("Druidcraft" in cantrip):
            cantrip += "\n- Druidcraft"
        if background == "Shaman" and Dice() == 1 and not ("Produce Flame" in cantrip):
            cantrip += "\n-  Produce Flame"
        if background == "Shaman" and Dice() == 1 and not ("Thorn Whip" in cantrip):
            cantrip += "\n-  Thorn Whip"
        ...
        if race == "Aberration" and Dice(7) == 1 and not ("Stench Spray" in one):
        ...
        if race == "Aberration" and Dice() == 1 and not ("Create Food and Water" in cantrip):
            cantrip += "\n- Create Food and Water. \n\t The monstrosity magically creates enough food and water to sustain itself for 24 hours."
        if race == "Aberration" and Dice() == 1 and not ("Rotting Gaze" in cantrip):
        ...
        if race == "Aberration" and Dice(7) == 1 and not ("Weird Insight" in cantrip):
        ...
        if race == "Aberration" and Dice() == 1 and not ("Confusion Ray" in cantrip):
        ...
        if race == "Aberration" and Dice(7) == 1 and not ("Paralyzing Ray" in cantrip):
        ...
        if race == "Aberration" and Dice() == 1 and not ("Fear Ray" in cantrip):
        ...
        if race == "Aberration" and Dice() == 1 and not ("Wounding Ray" in cantrip):
        ...
        if race == "Aven" and Dice(8) == 1 and not ("Summon Air Elemental" in cantrip):
        ...
        if race == "Beast" and Dice() == 1 and not ("Cold Breath" in cantrip):
        ...
        if race == "Beastfolk" and Dice(10) == 1 and not ("Sleep Gaze" in cantrip):
        ...
        if race == "Beastfolk" and Dice() == 1 and not ("Sacred flame" in cantrip):
            cantrip += "\n- Sacred Flame."
        if race == "Beastfolk" and Dice() == 1 and not ("Mage Hand" in cantrip):
            cantrip += "\n- Mage Hand (invisible)."
        if race == "Beastfolk" and Dice() == 1 and not ("Thaumaturgy" in cantrip):
            cantrip += "\n- Thaumaturgy."
        if race == "Beastfolk" and Dice() == 1 and not ("Feather Fall" in cantrip):
            cantrip += "\n- Feather Fall."
        if race == "Beastfolk" and Dice() == 1 and not ("Invisibility" in one):
            one += "\n- Invisibility (self only)."
        if race == "Beastfolk" and Dice() == 1 and not ("Cure Wounds" in one):
            one += "\n- Cure Wounds."
        if race == "Beastfolk" and Dice() == 1 and not ("Enlarge/Reduce" in one):
            one += "\n- Enlarge/Reduce."
        if race == "Beastfolk" and Dice() == 1 and not ("Heat Metal" in one):
            one += "\n- Heat Metal."
        if race == "Beastfolk" and Dice() == 1 and not ("Mirror Image" in one):
            one += "\n- Mirror Image."
        if race == "Beastfolk" and Dice() == 1 and not ("Blur" in two):
            two += "\n- Blur."
        if race == "Beastfolk" and Dice() == 1 and not ("Magic Weapon" in two):
            two += "\n- Magic Weapon."
        ...
        if race == "Construct" and Dice(2) == 1 and not ("Light" in cantrip):
            cantrip += "\n- Light"
        if race == "Construct" and Dice(2) == 1 and not ("Paralysis Gas" in cantrip):
        ...
        if race == "Celestial" and Dice(2) == 1 and not ("Light" in cantrip):
            cantrip += "\n- Light"
        if race == "Celestial" and Dice(2) == 1 and not ("Sacred flame" in cantrip):
            cantrip += "\n- Sacred flame"
        if race == "Celestial" and Dice(2) == 1 and not ("Thaumaturgy" in cantrip):
            cantrip += "\n- Thaumaturgy"
        if race == "Celestial" and Dice(2) == 1 and not ("Bless" in first):
            first += "\n- Bless"
            slots1 += Dice(3)
        if race == "Celestial" and Dice(2) == 1 and not ("Cure wounds" in first):
            first += "\n- Cure wounds"
            slots1 += Dice(3)
        if race == "Celestial" and Dice(2) == 1 and not ("Sanctuary" in first):
            first += "\n- Sanctuary"
            slots1 += Dice(3)
        ...
        if race == "Dragon" and Dice(12) == 1 and not ("Change Shape" in cantrip):
        ...
        if race == "Dragon" and Dice() == 1 and not ("Color Spray" in cantrip):
            cantrip += "\n- Color Spray"
        if race == "Dragon" and Dice() == 1 and not ("Dancing lights" in cantrip):
            cantrip += "\n- Dancing lights"
        if race == "Dragon" and Dice() == 1 and not ("Mage Hand" in cantrip):
            cantrip += "\n- Mage Hand"
        if race == "Dragon" and Dice() == 1 and not ("Minor Illusion" in one):
            one += "\n- Minor Illusion"
        if race == "Dragon" and Dice(8) == 1 and not ("Major Image" in one):
            one += "\n- Major Image"
        if race == "Dragon" and Dice(8) == 1 and not ("Mirror Image" in one):
            one += "\n- Mirror Image"
        if race == "Dragon" and Dice(8) == 1 and not ("Polymorph" in one):
            one += "\n- Polymorph"
        if race == "Dragon" and Dice(8) == 1 and not ("Suggestion" in one):
            one += "\n- Suggestion"

        if race == "Dwarf" and Dice() == 1 and not ("Enlarge" in cantrip):
        ...
        if race == "Dwarf" and Dice() == 1 and not ("Invisibility" in cantrip):
        ...
        if race == "Elemental" and Dice() == 1 and not ("Dancing lights" in cantrip):
            cantrip += "\n- Dancing lights"
        if race == "Elemental" and Dice() == 1 and not ("Cinder breath" in cantrip):
        ...
        if race == "Elemental" and Dice(7) == 1 and not ("Blinding breath" in cantrip):
        ...
        if race == "Elemental" and Dice(7) == 1 and not ("Steam breath" in cantrip):
        ...
        if race == "Elemental" and Dice() == 1 and not ("Fire Breath" in cantrip):
        ...
        if race == "Elemental" and Dice(3) == 1 and not ("Summon Mephits" in one):
        ...
        if race == "Elemental" and Dice() == 1 and not ("Innate Spellcasting" in one):
        ...
        if race == "Elemental" and Dice() == 1 and not ("Blur" in one):
            one += "\n- Blur"
        if race == "Elemental" and Dice() == 1 and not ("Sleep" in one):
            one += "\n- Sleep"

        if race == "Elf" and Dice() == 1 and not ("Dancing lights" in cantrip):
            cantrip += "\n- Dancing lights"
        if race == "Elf" and Dice() == 1 and not ("Darkness" in one):
            one += "\n- Darkness"
        ...
        if race == "Fey" and Dice() == 1 and not ("Entangle" in three):
            three += "\n- Entangle"
        if race == "Fey" and Dice() == 1 and not ("Goodberry" in three):
            three += "\n- Goodberry"
        ...
        if race == "Fiend" and Dice() == 1 and not ("Fire Breath" in cantrip):
        ...
        if race == "Fiend" and Dice() == 1 and not ("Ethereal Stride" in cantrip):
        ...
        if race == "Fiend" and Dice() == 1 and not ("Scare" in one):
        ...
        if race == "Fiend" and Dice() == 1 and not ("Fetid Cloud" in one):
        ...
        if race == "Gnome" and Dice() == 1 and not ("Nondetection" in cantrip):
            cantrip += "\n- Nondetection (self only)"
        if race == "Gnome" and Dice() == 1 and not ("Blindness/Deafness" in one):
            one += " \n- Blindness/Deafness"
        if race == "Gnome" and Dice() == 1 and not ("Blur" in one):
            one += " \n- Blur"
        if race == "Gnome" and Dice() == 1 and not ("Disguise Self" in one):
            one += " \n- Disguise Self"

        if race == "Goblin" and Dice() == 1 and not ("Leadership" in cantrip):
        ...
        if race == "Monstrosity" and Dice() == 1 and not ("Darkness Aura" in one):
        ...
        if race == "Monstrosity" and Dice() == 1 and not ("Acid Spray" in cantrip):
        ...
        if race == "Monstrosity" and Dice() == 1 and not ("Luring Song" in cantrip):
        ...
        if race == "Monstrosity" and Dice() == 1 and not ("Petrifying Gaze" in cantrip):
        ...
        if race == "Monstrosity" and Dice() == 1 and not ("Read Thoughts" in cantrip):
        ...
        if race == "Monstrosity" and Dice() == 1 and not ("Chilling Gaze" in cantrip):
        ...
        if race == "Ooze" and Dice() == 1 and not ("Psychic Crush" in cantrip):
        ...
        if race == "Snakefolk" and Dice() == 1 and not ("Animal Friendship" in cantrip):
            cantrip += "\n- Animal Friendship (snakes only)"
        if race == "Snakefolk" and Dice() == 1 and not ("Poison Spray" in three):
            three += "\n- Poison Spray"
        if race == "Snakefolk" and Dice() == 1 and not ("Suggestion" in three):
            three += "\n- Suggestion"

        if race == "Undead" and Dice(8) == 1 and not ("Corrupting Touch" in cantrip):
            cantrip += "\n - Corrupting Touch \n\t Melee Spell Attack: reach 5 ft., one target. Hit: 10 (3d6) necrotic damage."
        if race == "Undead" and Dice(8) == 1 and not ("Dreadful Glare" in cantrip):
        ...
        if race == "Undead" and Dice(8) == 1 and not ("Horrifying Visage" in cantrip):
        ...
        if race == "Undead" and Dice(8) == 1 and not ("Forceful Slam" in cantrip):
            cantrip += "\n - Forceful Slam \n\t Magic melee attack. Hit: 10 (3d6) force damage. "
        if race == "Undead" and Dice(8) == 1 and not ("Life Drain" in cantrip):
        ...
        if race == "Undead" and Dice(8) == 1 and not ("Rotting Fist" in cantrip):
        ...
        if race == "Undead" and Dice(8) == 1 and not ("Strength Drain" in cantrip):
        ...
        if race == "Undead" and Dice(8) == 1 and not ("Telekinetic Thrust" in cantrip):
        ...
        if race == "Undead" and Dice(8) == 1 and not ("Wail" in one):
...
def Actions(Type=""):
    ...
    if Type == "Aberration" and Dice(7) == 1:
    ...
    elif (Type == "Beast" or Type == "Beastfolk") and Dice(9) == 1:
    ...
    if (Type == "Beast" or Type == "Beastfolk") and Dice(10) == 1:
        r = r + \
    ...
    if (Type == "Beast" or Type == "Beastfolk") and Dice(12) == 1:
        r = r + "\n- Hold Breath. \n\t  The beast can hold its breath for 15 minutes.\n- Swimming \n\t  speed of 30 feet."
    elif (Type == "Beast" or Type == "Beastfolk") and Dice(12) == 1:
    ...
    if Type == "Beastfolk" and Dice(8) == 1:
    ...
    if Type == "Berserker" and Dice(2) == 1:
        r = r + "\n- Multiattack \n\t The berserker makes two simple melee attacks."
    if Type == "Berserker" and Dice(2) == 1:
        r = r + "\n- Reckless \n\t At the start of its turn, the berserker can gain advantage on all melee weapon attack rolls during that turn, but attack rolls against it have advantage until the start of its next turn."

    if Type == "Criminal" and Dice() == 1:
    ...
    if Type == "Elemental" and Dice(8) == 1:
        r += "\n - Illumination.\n\t The beast sheds bright light in a 10-foot radius and dim light for an additional 10 ft."
    elif Type == "Elemental" and Dice() == 1:
    ...
    if Type == "Elemental":
        if Dice() == 1:
            ...
            if rdm == 2:
                r = r + \
                    "Each creature in range must succeed on a DC [10+%Cha] Constitution Saving Throw or be blinded for 1 minute."
            if rdm == 3:
                r = r + \
                    "Each creature in range must succeed on a DC [10+%Cha] Constitution Saving Throw or take 4 (1d8) slashing damage on a failed save, or half as much on a successful one."
            if rdm == 4:
                r = r + \
                    "Each creature in range must succeed on a DC [10+%Con] Constitution Saving Throw or take 7 (2d6) fire damage on a failed save, or half as much on a successful one. Flammable objects that aren't being worn or carried in that area are ignited."
    ...
    elif Type == "Goblin" and Dice(10) == 1:
    ...
    if Type == "Lizardfolk" and Dice(2) == 1:
        r = r + \
    ...
    elif Type == "Monstrosity" and Dice() == 1:
    ...
    if Type == "Undead" and Dice(2) == 1:
        r = r + "\n Darkvision: 60ft"
    elif Type == "Undead" and Dice(2) == 1:
        r = r + "\n Darkvision: 120ft"

    if Type == "Undead" and Dice(2) == 1:
        r += "\n- Damage Vulnerabilities: Bludgeoning."
    if Type == "Undead" and Dice(3) == 1:
...
def Trait(background=""):
    Traits = [
        ...
        "Favored. Gav e a great advice to a merchant, which saved it from ruin. You have a standing invitation to visit the merchant's distant mansion.",
...
def NPC():
    ...
    print("Skills:")
    if Dice() <= Modifier(STR): print(f"\tAthletics:+{Proficiency(STR)}",  end=" ")
    if Dice() <= Modifier(DEX): print(f"\tAcrobatics:+{Proficiency(DEX)}", end=" ")
    if Dice() <= Modifier(DEX): print(f"\tSleight of Hand:+{Proficiency(DEX)}", end=" ")
    if Dice() <= Modifier(DEX): print(f"\tStealth:+{Proficiency(DEX)}", end=" ")
    if Dice() <= Modifier(INT): print(f"\tArcana:+{Proficiency(INT)}", end=" ")
    if Dice() <= Modifier(INT): print(f"\tHistory:+{Proficiency(INT)}", end=" ")
    if Dice() <= Modifier(INT): print(f"\tInvestigation:+{Proficiency(INT)}", end=" ")
    if Dice() <= Modifier(INT): print(f"\tNature:+{Proficiency(INT)}", end=" ")
    if Dice() <= Modifier(INT): print(f"\tReligion:+{Proficiency(INT)}", end=" ")
    if Dice() <= Modifier(WIS): print(f"\tAnimal Handling:+{Proficiency(WIS)}", end=" ")
    if Dice() <= Modifier(WIS): print(f"\tInsight:+{Proficiency(WIS)}", end=" ")
    if Dice() <= Modifier(WIS): print(f"\tMedicine:+{Proficiency(WIS)}", end=" ")
    if Dice() <= Modifier(WIS): print(f"\tPerception:+{Proficiency(WIS)}", end=" ")
    if Dice() <= Modifier(WIS): print(f"\tSurvival:+{Proficiency(WIS)}", end=" ")
    if Dice() <= Modifier(CHA): print(f"\tDeception:+{Proficiency(CHA)}", end=" ")
    if Dice() <= Modifier(CHA): print(f"\tIntimidation:+{Proficiency(CHA)}", end=" ")
    if Dice() <= Modifier(CHA): print(f"\tPerformance:+{Proficiency(CHA)}", end=" ")
    if Dice() <= Modifier(CHA): print(f"\tPersuasion:+{Proficiency(CHA)}", end=" ")
    print("\n")
