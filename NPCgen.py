...
def Title():
    descriptor = [
        ...
        "Reptilian","Raven-haired","Raptor-clawed","Radiant", "Renaissance", "River",
        "Slime-covered",        "Snail-shelled",        "Sphinx-faced",        "Spined",        "Squirrel-tailed","Stinger-tailed","Simian","Shell-backed","Shark-toothed","Serpentine","Scaled", "Scarlet", "Sirenic", "Silent", "Solar", "Stellar", "Stoic", "Swift", "Sword", 
        ...
        "Amulet",
        "Anvil",
        "Apothecary",  # Relating to a person who prepared and sold medicines in past times
        "Arch",  # An architectural element
        "Banner",
        "Blade",
        "Brooch",
        "Candle",
        ...
        "Chest",
        "Clockwork",  # Mechanism with a complex series of gears
        "Compass",
        "Crown",
        "Dagger",
        ...
        "Gavel",  # A mallet used by a judge or an auctioneer
        "Goblet",
        "Grail",  # Often refers to the Holy Grail
        "Hammer",
        "Hourglass",
        "Inkwell",
        "Jewel",
        ...
        "Medallion",
        "Mirror",
        "Orb",  # A spherical object; often used in a royal context
        "Parchment",
        "Pendulum",
        "Phylactery",  # Small box containing Jewish texts; also a charm or amulet in other cultures
        "Quill",  # A pen made from a bird's feather
        "Relic",  # An object surviving from an earlier time, especially one with historical interest
        "Rune",  # A letter in a runic alphabet used by Germanic peoples
        "Scepter",  # An ornamented staff carried by rulers as a symbol of power
        "Scroll",
        "Seal",  # An engraved device for stamping a design onto something soft, like wax
        "Shield",
        "Sigil",  # An inscribed or painted symbol or sign
        "Spire",  # A tall, pointed structure on top of a building, especially a church or cathedral
        "Staff",
        "Sword",
        "Tapestry",
        "Totem",  # A natural object or animal believed by a particular society to have spiritual significance
        "Urn",
        "Vellum",  # Fine parchment made from calf's skin
        "Vessel",  # A ship or large boat; or a hollow container
        "Wand",
        "Wheel",
        "Whistle"
        "Ancient",
        "Aztec",
        "Baroque",  # Relating to a style of European architecture, music, and art in the 17th and 18th centuries
        "Byzantine",  # Relating to the Byzantine Empire, known for its intricate art and mosaics
        "Celtic",
        "Colonial",
        "Confucian",  # Relating to the Chinese philosopher Confucius
        "Crusader",  # Relating to the medieval military expeditions made by Europeans to recover the Holy Land
        "Dynastic",  # Relating to a sequence of rulers from the same family or group
        "Edwardian",  # Relating to the reign of King Edward VII of the UK (1901–1910)
        "Elizabethan",  # Relating to the time when Elizabeth I was queen of England (1558–1603)
        "Feudal",  # Relating to the medieval system of lords and vassals
        "Flapper",  # Relating to the 1920s women known for their energetic freedom and embracing the Jazz Age
        "Gregorian",  # Relating to Pope Gregory I or the Gregorian chant
        "Han",  # Relating to the Han dynasty of China
        "Hellenistic",  # Relating to the time after Alexander the Great, when Greek culture spread
        "Hermitage",  # Relating to a hermit's dwelling or the Hermitage Museum in St. Petersburg, Russia
        "Incan",
        "Jacobean",  # Relating to the time when James I was king of England (1603–1625)
        "Jazz Age",  # The 1920s in the U.S., characterized by jazz music
        "Medieval",
        "Mesopotamian",  # Relating to the region between the Tigris and Euphrates rivers, one of the cradles of civilization
        "Mughal",  # Relating to the Mughal dynasty of India
        "Napoleonic",  # Relating to Napoleon Bonaparte
        "Norman",  # Relating to the Normans, particularly the Norman conquest of England in 1066
        "Ottoman",  # Relating to the Ottoman Empire
        "Pharaonic",  # Relating to the ancient pharaohs of Egypt
        "Prohibition",  # Relating to the 1920–1933 period in the U.S. when alcohol was illegal
        "Renaissance",  # The cultural rebirth in Europe between the 14th and 17th centuries
        "Romanesque",  # Relating to a style of architecture prevalent in Europe in the 11th and 12th centuries
        "Samurai",  # Relating to the medieval and later warrior class of Japan
        "Sanskrit",  # Relating to the ancient Indo-European language of India
        "Spartan",
        "Tudor",  # Relating to the period of the Tudor dynasty in England (1485–1603)
        ...
        "Exoplanetary",  # Relating to exoplanets, which are planets outside our solar system
        "Extraterrestrial",
        "Galactic",
        "Gravitational",
        "Heliospheric",  # Relating to the region of space influenced by our sun
        "Interstellar",
        "Lunar",
        "Magnetospheric",  # Relating to a planet's magnetosphere
        "Meteoritic",  # Relating to meteors
        "Nebulous",  # Resembling a nebula; also vague or ill-defined
        "Neutron",  # Relating to neutron stars
        "Orbital",
        "Pulsar",  # A highly magnetized, rotating neutron star
        "Quasar",  # An extremely bright and distant point in space powered by black holes
        "Radiant",  # Emitting or reflecting light; also can mean emanating great joy or love
        "Satellite",
        "Solar",
        "Spacetime",  # The fusion of the three dimensions of space and the one dimension of time
        "Stellar",  # Relating to stars
        "Suborbital",
        "Supernova",  # A star that suddenly increases in brightness due to an explosion
        "Telescopic",  # Relating to or seen through a telescope
        ...
        "Epochal",  # Pivotal or defining for an epoch or era
        "Eternal",
        ...
        "Instantaneous",
        "Interim",
        "Matinal",  # Of or relating to the early morning
        "Meridian",  # Of or relating to midday
        "Millennial",
        "Momentary",
        "Nocturnal",
        "Obsolete",
        ...
        "Punctual",
        "Quotidian",  # Everyday or ordinary
        "Seasonal",
        "Secular",  # Lasting a century or denoting attitudes or activities free from religious or spiritual basis
        ...
        "Solar",
        "Summer",
        "Tender","Third","Thunder","Tiger","Titan","True","Trival","Tomb",
        "Valiant","Vampiric","Veteran","Violet","Voice","Void", "Voidborne", 
        "War","Wrathful","Warlord","Warping","Water","White","Wise","Wind","Winter","Wild","Wolf",
        "Young",
        "Zombie",
        ""
    ]
    ...
    rank = [
    "Prelate", "Cleric", "Bishop", "Archbishop", "Cardinal", "Friar", "Deacon", "Priestess", "High Priest", "Monk", "Nun", "Matriarch", "Patriarch", "Abbot", "Abbess", "Canon", "Vicar",
    "Samurai", "Ninja", "Daimyo", "Raj", "Brahmin", "Pharaoh", "Lama", "Shaman", "Chieftain", "Tribe Leader", "Warlord", "Mogul", "Pasha",
    "Scholar", "Librarian", "Professor", "Tutor", "Lecturer", "Reader", "Dean", "Fellow",
    "Lieutenant", "Sergeant", "Major", "Colonel", "General", "Admiral", "Captain", "Commander", "Centurion", "Legate", "Marshal", "Brigadier", "Ensign", "Cadet",
    ...
    "Heart of Eldorado",
    "Gilded Voyager",
    "Lost Conquistador of Eldorado",

    // Spanish Conquistadors & Colonial Era
    "Cortes' Heir",
    "Pizarro's Shadow",
    "De Leon's Immortal Pursuer",
    ...
    "Guardian of La Mancha",

    // Italian Tales
    "Oracle of the Sibyl",
    "Nemesis of Strega",
    "Vesuvius' Flamekeeper",
    "Pompeii's Ghostseer",
    "Colosseum Gladiator",
    "Borgia's Intrigue",
    "Maskbearer of Venice",
    "Romulus' Descendant",
    
    // Middle Eastern Tales
    "Djinn Whisperer",
    "Voyager of the Endless Sands",
    "Lampbearer of the Forbidden Cave",
    "Guardian of the Forty Thieves",
    ...
    "Serpentseer Fuxi",
    "Guardian of the Thousand Tears",
    ...
    "Totem's Voice",
    "Tobacco Spirit",
    "Maze Runner",  # Reference to the ancient Puebloan structures
    "Cacao Mystic",
    "Dreamcatcher",
    "Star Quilter",
    "Rain Dancer",
    "Sun Stone's Keeper",  # Reference to the Aztec sun stone
    "Moon's Maiden",
    "Raven's Tale",
    "Manitou's Chosen",
    "Cacao Bringer",  # Reference to the importance of chocolate in ancient Mesoamerica
    "Maize Guardian",
    "Potato Sage",  # Potato being native to South America
    "Llama Rider",
    "Nazca Enigma",  # Inspired by the Nazca Lines
    "Inca's Echo",
    "Tobacco Seer",
    "Wendigo's Kin",
    "Rattlesnake's Fang",
    "Spiderwoman's Web",  # Reference to the Hopi legend
    "Sequoia's Strength",
    "Turtle Islander",  # Native American name for North America
    "Kokopelli's Song",
    "Noble Sachem",
    "Mystic Mestizo",
    "Olmec's Legacy",
    ...
    "Peyote Visionary",
    "Totem's Echo",
    "Silver Mountains Seeker",  # Reference to the legendary Sierra de la Plata
    "Algonquin's Light",
    "Poncho's Pride",
    "Sasquatch's Kin",
    "River's Gem" 
...
def Racial_Names(Type):
    Names = [
        "Caspian", "Nemo", "Ada", "Pascal", "Byron", "Arthurius", "Neo", "AbErrant", "Dorian", 
        "Narkia", "Anarkia", "Anakin", "Draven", "Furiosa", "Goku", "Jareth", "Maleficent", 
        "Kratos", "Xena", "Zorro", "Forajido", "Paragon", "Amelia", 
        "Morpheus", "Trinity", "Ripley", "Leia", "Luke", "Maximus", "Arya", "Odin", 
        "Ragnar", "Loki", "Athena", "Dante", "Orion", "Alucard", "Thorin", "Legolas", 
        "Strider", "Spartacus", "Elektra", "Storm", "Logan", "Wolverine", "Rogue", 
        "Phoenix", "Mystique", "Cersei", "Daenerys", "Khal", "Brienne", "Oberyn", 
        "Raven", "Sabrina", "Seraph", "Azrael", "Lucifer", "Castiel", "Crowley", 
        "Maverick", "Icarus", "Circe", "Nyx", "Osiris", "Horus", "Perseus", "Cronos", 
        "Medusa", "Tyrion", "Lysandra", "Aelin", "Rowan", "Daemon", "Altair", "Ezio", 
        "Desmond", "Leonardo", "Ramses", "Cleopatra", "Ares", "Hera", "Zeus", 
        "Midas", "Echo", "Narcissus", "Sylar", "Kai", "Rhea", "Mara", "Kali", 
        "Draco", "Bellatrix", "Vega", "Nyx", "Thalia", "Titan", "Nova", "Solaris"
    ]

    Humans = [
    "Emelot", "Jean", "Frank", "Albertus", "Isildur", "Aragorn", "Theoden", "Lancelot", "Anselm", 
    "Thomas", "Nicole", "Herbin", "Elisabeth", "Katarina", "Beau", "Reginald", "Ernest", "Aubert", 
    "Neil", "Denis", "Menard", "Euphemia", "Lucy", "Oda", "Lazarus", "Blanche", "Regina", 
    "Jasper", "Anastasia", "Mathilda", "Brian", "George", "Colbert", "Hubert", "James", 
    "William", "Nathaniel", "Edric", "Edward", "Christopher", "Martin", "Emma", "Avis", 
    "Wilmot", "Audrey", "Cecilia", "Joy", "Joan", "Tobias", "Mark", "Solomon", "Eve", "Alice", 
    "Berthold", "Hypatia", "Pythagoras", "Hercules", "Pascal", "Marie", "Curie", "Bruce", 
    "Arthur", "Merlin", "Galahad", "Tristan", "Isolde", "Robin", "Marian", "Sigurd", "Brunhild", 
    "Ragnar", "Roland", "Roderick", "Elaine", "Morgana", "Uther", "Iseult", "Geraint", 
    "Percival", "Gawain", "Bedivere", "Cedric", "Leif", "Erik", "Harald", "Olaf", "Charlemagne", 
    "Beowulf", "Frederick", "Louis", "Eleanor", "Isabella", "Ferdinand", "El Cid", "Alfred", 
    "Edward", "Matilda", "Henry", "Richard", "Philip", "Joan", "Eloise", "Abelard", 
    "Daedalus", "Theseus", "Odysseus", "Penelope", "Helen", "Paris", "Hector", "Orpheus", 
    "Eurydice", "Siegfried", "Gudrun", "Attila", "Boudicca", "Vercingetorix", "Augustus", 
    "Julius", "Caesar", "Cleopatra", "Marcus", "Lucius", "Octavia", "Titus", "Claudius", 
    "Nero", "Cicero", "Spartacus", "Ovid", "Virgil", "Horace", "Augustine", "Gregory", 
    "Ambrose", "Jerome", "Rollo", "Ivan", "Peter", "Catherine", "Anastasia", "Nicholas", 
    "Rasputin", "Vladimir", "Alexei", "Maria", "Olga", "Tatiana", "Percy","Percival",
    "Vigo", "Albus", "Isabella", "Louis", "Jeremias", "Luz", "Belos" 
    ]
    if Type == "Human": return Humans + Names
    Names += Humans
    ...
    "Aerandir",
    "Aeris",
    "Aero", "Adalara", "Adalin", "Adran", "Adrie", "Ag", "Alador",
    "Alagos", "Alathaea", "Aldovale", "Alima", "Alorio", "Althaea", "Althos", "Amastacia", "Amelia", "Amity", "Anali", "Anakin", 
    "Andraste", "Ang", "Angorn", "Angrod", "Annon", "Anastriana", "Antinua", "Anthon", "Ara", "Aramil", "Aranel", "Aranis", "Araphor",
    "Arathorn", "Aratlion", "Arondir", "Arthern", "Arannis", "Arn", "Aro", "Arphor", "Arros", "Arthalion", "Arthriol", "Asur", 
    "Astrid", "Athos", "Atro", "Aubren", "Aust", "Austio", "Autumnfall", "Ava", "Avafi", "Azaki", "Austio", "Austarion", "Autumn",
    "Baldric", "Banderliss", "Bark", "Barathor", "Basha", "Bella", "Belladonna", "Beren", "Bertin", "Birel", "Birel", "Bleonal",
    "Blim", "Blorin", "Bodil", "Bor", "Borivik", "Boromir", "Bral", "Brannon", "Brath", "Brithiel", "Brodin", "Broe", "Brom",
    "Bryn", "Brueral", "Byrius", "Cael", "Caelin", "Caelum", "Caladwen", "Caran", "Carric", "Caspian", "Celtana", "Certhel",
    "Celeborn", "Celebrian", "Celebriel", "Celebrimbor", "Certhel", "Chel", "Chelri", "Cirdan", "Clagna", "Claira", "Cothiel",
    "Curufin", "Curulire", "Cuthalion", "Daeron", "Dalanzal", "Danel", "Dartagnan", "Dawnpath", "Del", "Delian", "Deloth", 
    "Denethor", "Denir", "Dilon", "Dinendal", "Dineloth", "Donael", "Donathan", "Dor", "Dorin", "Dorn", "Douglas", "Draven", "Driel",
    "Drusilia", "Durin", "Durgwen", "Earendil", "Eariol", "Earwen", "Eda", "Edalin", "Edan", "Edrial", "Edriol", "Eero", "Egorn", 
    "Eilinora", "Eilri", "Eiro", "Elandrial", "Elanor", "Ela", "Elenia", "Eleonor", "Elendil", "Elendithas", "Elennanor", "Elenwe", 
    "Elestirne", "Elessar", "Elhalyn", "Elion", "Elmo", "Elphir", "Elriol", "Elrond", "Elros", "Elrohir", "Elu", "Elwen", "Elwing",
    "Elion", "Eli", "Elian", "Elior", "Elinor", "Elwe", "Elyan", "Elerian", "Elthorin", "Elerossë", "Elphir", "Elvandar", "Eol", 
    "Eolande", "Eoliel", "Eoloriel", "Eorl", "Ephelion", "Erevan", "Eriol", "Erin", "Ermo", "Ero", "Erol", "Eru", "Erwen", "Eryn",
    "Ethalion", "Ethir", "Faelir", "Fae", "Faen", "Fael", "Faelon", "Faenor", "Fara", "Farin", "Faral", "Felosial", "Fen", "Fera",
    "Ferumbras", "Feantur", "Feanor",
    "Aelthion",
    "Adalara",
    "Adal",
    "Ada",
    ...
    "Adrie", 
    "Aera",
    "Aevis", "Aldovale", "Alagos", "Alador", "Alimo", "Alima", "Alyssum", "Amastacia", "Amberpath", 
    "Amelia", "Amity", "Anali", "Andraste", "Ang", "Angorn", "Anastriana", "Anarkia", "Anakin", "Antinua", 
    "Ara", "Aralph", "Aramil", "Arandin", "Araran", "Aranis", "Arathor", "Ari", "Arizima", "Arondir", 
    "Arn", "Aro", "Arthurius", "Arthur", "Arzein", "Arne", "Aro", "Aslyssum", "Astrid", "Atala", 
    "Aubert", "Aust", "Austio", "Autumn", "Autumnheart", "Awaldiel", "Avis", "Azaki", "Bai", "Baldric", 
    "Banderliss", "Barathor", "Bark", "Basha", "Beaux", "Beiro", "Belos", "Bella", "Belladona", "Berevan", 
    "Berrian", "Betha", "Bertin", "Birel", "Birel", "Blath", "Blein", "Blanchet", "Bleonal", "Blim", 
    ...
    "Cuarion", "Curie", "Curu", "Daneloth", "Dartagnan", "Dartañan", "Dartagnan", "Dartañan", "David", "Dawnpath", 
    ...
    "Eufemia", "Euler", "Eurin", "Evadne", "Evandel", "Evanescense", "Eve", "Evidam", "Eyla", "Faelir", 
    "Faen", "Faera", "Fae", "Faethis", "Faila", "Fai", "Falchion", "Fandel", "Fan", "Fanal", 
    "Faelir", "Faen", "Faera", "Faethis", "Fai", "Faila", "Falchion", "Fandel", "Fan", "Fanal",
    "Fandel", "Fandral", "Fara", "Faral", "Faelorn", "Faralin", "Farol", "Feanor", "Felicity", "Felosial",
    "Fen", "Fera", "Feralia", "Featherspark", "Felan", "Feravel", "Feremar", "Feyla", "Feylin", "Filius",
    "Fingolfin", "Firael", "Foli", "Forestmoon", "Forestflower", "Forestheart", "Forojol", "Fral", "Frelia", "Freya",
    "Froemar", "Galadriel", "Galdor", "Galindan", "Gara", "Gawain", "Gael", "Gara", "Gerngwen", "Glorfindel",
    "Goldleaf", "Gus", "Goku", "Galdric", "Galin", "Galor", "Galthor", "Glyn", "Haedir", "Hadarai",
    "Halana", "Heian", "Holara", "Horatio", "Horneth", "Huroz", "Iannien", "Iellan", "Ienor", "Ilanis",
    ...
    "Kan", "Kari", "Karnwyl", "Karn", "Kay", "Keiro", "Keyleth", "Kern", "Kratos", "Kylar",
    "Laucian", "Lael", "Laer", "Larin", "Lauriel", "Laurin", "Leshanna", "Lia", "Liliandil", "Liadon",
    "Lilis", "Lirn", "Lithor", "Lora", "Loria", "Loria", "Loriel", "Lorin", "Lue", "Lura",
    "Luthien", "Lyfaen", "Lyrial", "Mai", "Maindaer", "Malkis", "Mara", "Maleficent", "Maralen", "Maur",
    "Melehtion", "Melwen", "Mella", "Meriele", "Merric", "Mialee", "Mial", "Mindartis", "Mial", "Mistwatcher",
    "Morhel", "Morwen", "Mya", "Mykar", "Myla", "Myr", "Nae", "Naeris", "Naivara", "Nail",
    ...
    "Paelia", "Pascal", "Pegnith", "Peren", "Peri", "Peria", "Pharana", "Quildohtare", "Quelenna", "Quinar",
    "Rain", "Raine", "Raingaze", "Rael", "Raelim", "Raer", "Raen", "Ravenflow", "Ravenwatcher", "Ridaro",
    "Relix", "Ren", "Reseo", "Riardon", "Rithel", "Rocenel", "Roden", "Roen", "Rolan", "Rolen",
    "Rua", "Rumathran", "Ryann", "Ryer", "Rym", "Sael", "Sai", "Sann", "Sariel", "Saynal",
    "Shava", "Soderac", "Sovelis", "Starwatcher", "Starwhisper", "Sudelrin", "Sumi", "Sumnes", "Syllin", "Sylvaranz",
    "Sylv", "Tauriel", "Thia", "Thranduil", "Tindecet", "Tris", "Trian", "Valance", "Vadan", "Valna",
    "Vanimial", "Vall", "Van", "Vanes", "Vax", "Vaxeldan", "Vex", "Vexhalia", "Viasta", "Wasanzi",
    "Wil", "Wenion", "Xanapia", "Xyrkraken", "Xylia", "Yael", "Yaeldrin", "Yesstina", "Zamior", "Zarivol",
    "Zay", "Zelaerys", "Zelir", "Zeren", "Zia", "Zorro"
    ...
    Orcs =[
    "Aldis", "Arn", "Asfrid", "Asterix", "Axe", "Balli", "Bjorn", "Blod", "Bulak", "Carguk",
    "Erek", "Erik", "Engli", "Farkang", "Gell", "Gnarsh", "Gorga", "Grog", "Grigi", "Gro",
    "Greiland", "Henk", "Holg", "Hosvir", "Idefix", "Ingrid", "Iuli", "Jor", "Lagazi", 
    "Merida", "Obelix", "Olof", "Ovif", "Ozerix", "Panoramix", "Ragnar", "Sagu", "Sarod", 
    "Skegg", "Skard", "Skuf", "Sveik", "Svein", "Svafar", "Steinolf", "Steg", "Thorkell", 
    "Thorald", "Thorlak", "Trag", "Trarik", "Tyrfing", "Torrad", "Vifil", "York", "Yurk", "Ñor",
    "Warbrute",
    "Bladebreaker",
    "Ironclad",
    "Tusker",
...
class MarkovChain:
    ...
    def add_transition(self, current_element, next_element):
    ...
    def generate(self, starting_element = random.choice('ABCDEFGHIJKLMNOPQRSTUVWXYZ'), max_length=15):
        output = [starting_element]
        while True:
            if output[-1] in self.transitions and len(output) < max_length:
...
def NPC():
    ...
    generator.train(training_names)
    ...
    try: 
        ...
        question += "\n Include some fitting explanation for that title, or nickname, such as an anecdote or great feat related to this naming." 
