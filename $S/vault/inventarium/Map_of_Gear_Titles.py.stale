...
_NOUNS: tuple[tuple[tuple[str, ...], tuple[str, ...]], ...] = (
		(
				(
						"Longsword",
						"Shortsword",
...
_CULTURES: tuple[tuple[tuple[str, ...], str], ...] = (
		(
				(
						"Dragonborn",
						"Dragon",
		...
		# Kobolds are draconic, so they read Sino-Japanese too — but Julio
		# places them a little to one side of it. Korea sits between those
		# neighbours while remaining its own thing, so a Kobold draws on both
		# registers and lands somewhere no other species does.
		(
				(
						"Kobold",
						),
		...
		# Gnomes are not only Renaissance Italy and Germany: Julio places
		# SWITZERLAND with them as the middle point — geographically between
		# the two, and with a famous military tradition of its own (halberd,
		# pike square, Lucerne hammer). A second register, as Kobolds have.
		(
				(
						"Gnome",
						),
		...
		# Class, not species: Monks read as ninja across every people.
		(
				(
						"Monk",
						),
...
_CULTURAL_NOUNS: dict[str, dict[str, tuple[str, ...]]] = {
		"sinojapanese": {
				"Longsword": ("Katana", "Jian"),
				"Greatsword": ("Nodachi", "Odachi", "Zhanmadao"),
				"Shortsword": ("Wakizashi",),
				"Dagger": ("Tanto", "Kunai"),
				"Glaive": ("Naginata", "Guandao"),
				"Sickle": ("Kama",),
				"Spear": ("Yari", "Qiang"),
				"Club": ("Nunchaku", "Tetsubo"),
				"Quarterstaff": ("Bo", "Jo"),
				"Dart": ("Shuriken",),
				"Blowgun": ("Fukiya",),
				"Longbow": ("Yumi", "Daikyu"),
		...
		"indopersian": {
				"Scimitar": ("Talwar", "Shamshir", "Kilij"),
				"Dagger": ("Jambiya", "Katar", "Khanjar"),
				"Longsword": ("Khanda",),
				"Whip": ("Urumi",),
				"Trident": ("Trishula",),
				"Battleaxe": ("Tabar",),
		...
		# Africa, read across the whole continent and its history: Sub-Saharan
		# (Zulu, Yoruba, Somali), Egyptian, Berber and Moorish, and Punic
		# Carthage — whose armies fielded Iberian and Balearic weapons.
		"african": {
				# Kaskara (Sudanese) and Takouba (Tuareg) are STRAIGHT swords,
				# so they belong here rather than under Scimitar.
				"Longsword": ("Kaskara", "Takouba", "Jineta"),
				"Shortsword": ("Ida", "Khopesh", "Falcata"),
				"Scimitar": ("Shotel", "Nimcha", "Flissa", "Khopesh", "Falcata"),
				"Dagger": ("Billao", "Koummya"),
				"Javelin": ("Assegai", "Iklwa", "Soliferrum", "Numidian Javelin"),
				"Spear": ("Iklwa", "Assegai"),
				"Club": ("Knobkerrie", "Was Sceptre"),
				"Quarterstaff": ("Heka Crook", "Was Sceptre"),
				"Flail": ("Nekhakha",),
				"Mace": ("Pear Mace",),
				"Battleaxe": ("Epa", "Epsilon Axe"),
				"Shortbow": ("Pedjet",),
				"Longbow": ("Pedjet",),
				"Sling": ("Balearic Sling",),
				"Shield": ("Ishlangu", "Nguni Shield", "Caetra", "Lamt"),
				},
		# The Viking-themed people (Julio: "the Elfs are the viking themed
		# other people"), reaching east through the Rus to the Mongols and
		# west to the Celts. Old Norse words sit here, not with the Gnomes.
		"northern": {
				"Greataxe": ("Dane Axe", "Breidox"),
				"Battleaxe": ("Bearded Axe", "Skeggox"),
				"Dagger": ("Seax", "Sgian Dubh"),
				"Shortsword": ("Langseax",),
				"Greatsword": ("Claymore",),
				"Longsword": ("Ulfberht",),
				...
				"Scimitar": ("Shashka",),
				"Spear": ("Ash Spear", "Gierr"),
				"Glaive": ("Atgeir",),
				"Halberd": ("Atgeir",),
				"Chain Mail": ("Brynja", "Hringserkr"),
				"Chain Shirt": ("Brynja",),
				"Shield": ("Round Shield", "Targe", "Skjoldr"),
				},
		"iberian": {
				"Rapier": ("Espada Ropera", "Bilbo"),
				"Longsword": ("Toledo Blade", "Espada"),
				"Greatsword": ("Montante",),
				"Dagger": ("Vizcaína", "Daga"),
				"Shield": ("Rodela", "Adarga"),
				"Halberd": ("Alabarda",),
				"Musket": ("Arcabuz",),
				"Pistol": ("Pedreñal",),
				"Breastplate": ("Coselete", "Peto"),
				"Plate": ("Armadura",),
				},
		"renaissance": {
				"Dagger": ("Cinquedea", "Stiletto", "Rondel"),
				"Greatsword": ("Zweihander", "Bidenhänder", "Spadone"),
				"Shortsword": ("Katzbalger",),
				"Rapier": ("Panzerstecher", "Schiavona"),
				"Longsword": ("Langes Messer", "Spada"),
				"Halberd": ("Hellebarde",),
				"Shield": ("Pavise", "Rotella"),
		...
		"hellenic": {
				...
				"Pike": ("Sarissa",),
				"Shield": ("Aspis", "Hoplon"),
				"Scimitar": ("Makhaira", "Kopis"),
				"Club": ("Rhopalon",),
				"Sling": ("Sphendone",),
				"Padded": ("Linothorax",),
				"Leather": ("Linothorax",),
				},
		# Swiss — the middle point of the Gnome blend, sitting between the
		# Italian and German traditions and famous in its own right: the
		# halberd, the pike square, the Lucerne hammer, the Basel dagger.
		"swiss": {
				"Halberd": ("Schweizer Halbarte", "Sempacher Halbarte"),
				"Pike": ("Langspiess", "Schweizer Pike"),
				"Warhammer": ("Luzerner Hammer",),
				"Maul": ("Luzerner Hammer",),
				"Dagger": ("Baselard", "Schweizerdegen"),
				"Shortsword": ("Baselard",),
				"Scimitar": ("Schweizersäbel",),
				"Glaive": ("Vouge",),
				"Spear": ("Ahlspiess",),
				"Morningstar": ("Morgenstern",),
				"Greatsword": ("Schweizer Bidenhänder",),
				"Musket": ("Handrohr",),
				},
		# Korean — its own tradition, neighbouring the Sino-Japanese one a
		# Kobold also draws from.
		"korean": {
				"Longsword": ("Hwando", "Geom"),
				"Greatsword": ("Ssangsudo",),
				"Shortsword": ("Hwando",),
				"Glaive": ("Woldo",),
				"Spear": ("Changgeom",),
				"Longbow": ("Gakgung",),
		...
		"ninja": {
				"Dart": ("Shuriken",),
				"Sickle": ("Kama", "Kusarigama"),
				"Club": ("Nunchaku",),
				"Quarterstaff": ("Bo", "Jo"),
				"Dagger": ("Tanto", "Kunai"),
				"Shortsword": ("Ninjato",),
				"Flail": ("Kusarigama", "Kusari-Fundo"),
				"Blowgun": ("Fukiya",),
				},
		}
