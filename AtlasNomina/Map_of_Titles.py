...
def Descriptor(lusor):
	...
	try:
		...
		descriptor += [ # O
			...
			"Orb",			
			"Orbit",			
			"Orbital",			"Orbiting",			"Orchard",			"Orchid",			"Orphean",			"Otherworldly",	 "Outlandish",			
			"Outpost",			"Outraged",			"Outrageous",	"Overgrown",	
			"Overlord",			"Owl",			"Ozone",		"Order",			"Oceanic",			"Orange",			"Old",			"Otherworld",
			]
		descriptor += [ # P
			"Power",			
			"Phantom",		"Prismatic",		"Prehistoric",	"Petrifying",		"Petrified",		"Perplexing", 		"Pensive",	"Political",		
			"Polar",			"Primordial",		"Perpetual",		"Perennial",		"Purifying",		"Pure",		"Primeval",			"Plague",			"Pain",				"Palace",	"Pathfinder",		"Patriarch",			"Patriarchal",		"Paw",	"Peaceful",			"Pearl",			"Pearlescent",		"Peat",					"Pendant",			"Pensive",			"Perceptive",		"Peregrine",		"Perennial",		"Perilous",	
			"Pernicious",		"Perpetual",			"Petal",			"Petrified",			"Phalanx",			"Phantasm",			"Phantasmagorical",				
			"Phantasmal",		"Phantom",			"Pharaonic",		"Pharaonic",		"Philosophical",	"Phlegmatic",		"Phoenix",			"Phoenixian",		"Phylactery",		"Pietistic",		"Pillar",			"Pine",				"Pinnacle",			"Pioneering",		"Piqued",						
			"Placid",			"Plague",			"Planar",			"Planetary",			"Plasma",			"Plateau",			"Platinum",		"Pleasant",				"Plucky",			"Plum",				"Poet",				"Poetic",			"Poignant",			"Poisonous",		"Polar",			"Pond",				"Ponderous",		"Pontifical",		"Poppy",			"Porcelain",		"Port",							"Potent",			"Potion",			"Powder",			"Power",			"Poker",			"Powerhouse",			"Prairie",			"Plague",		"Precious",		"Precocious",	"Predatory",	"Preternatural",	"Primal",			"Prime",			"Primeval",			"Primordial",		"Princely",			"Prismatic",		"Prison",			"Private",			"Profound",			"Prohibition",		"Promethean",		"Prophetic",		"Prosperous",		"Protected",		"Proud",		"Psion",		"Pugnacious",		"Pulsar",		"Pulsating",		"Pumpkin",		"Pungent",		"Punk",			"Pure",			"Purifying",	"Purist",		"Purple",			"Puzzled",			"Pyramid",			"Pyro",				"Palm",				"Pandemonium",		"Panicked",			"Papal",			"Paradox",			"Paradoxical",		"Parched",			"Parish",			"Park",				"Parliament",		"Passionate",		"Pack",				"Phantom",			"Primal",			"Pillager",			"Power",			"Powerful",			"Pain",			"Pack",			"Pain",			"Pure",						"Plague",			"Primal",			"Prehistoric",		"Primigenial",		"Primordial",		"Proud",			"Planar",
			]
		descriptor += [ # Q
		...
		descriptor += [ # R
			...
			"Rosy",			"Royal",		"Ruby",			"Rugged",		"Ruined",		
			"Ruins",			"Rule",			"Rune",			"Runecarved",		
			"Runewielder",	"Runic",		"Rural",		"Rust",			"Rustic",		
		...
		descriptor += [ # V
			...
			"Vapor",		
			"Vaporous",		
			"Vase",			"Veiled",			"Victorious",		
			"Vigilant",			
			"Viking",				
			"Village",			
			"Villainous",		
			"Vindicator",	"Vindictive",		
			"Vine",				
			"Vintage",			
			"Violent",			"Violet",			
			"Viridian",				
			...
			"Virulent",				
			"Visage",			"Visionary",				
			"Vitriolic",	"Void",			"Vengeful",		"Voidborne",	"Voided",		
			"Voidless",		"Volatile",			"Volcanic",			"Volcano",				
			"Voracious",		"Vortex",			"Vulcanian",		"Vulpine",			
			"Void",				"Void",				"Void",				"Vengeance",				
			"Vellum",				"Vendetta",				"Venerable",				
			"Vengeance",				"Vengeful",				"Venomous",		"Valiant",		
			"Venusian",		"Verdant",		"Vermilion",	"Vernal",		
			"Vertex",		"Vesper",		"Vesperal",			"Vessel",			
			"Veteran",			"Vibrant",			"Vicar",			"Vicious",			
			"Violet",			"Valiant",			"Vampiric",				"Veteran",				
