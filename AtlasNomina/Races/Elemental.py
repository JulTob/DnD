...
Air_Elementals = [
 ...
 "Caelistis",
 "Aero", "Aelio", "Aeolian",
 "Gale", "Zefir", "Zefyr", "Zephyr", "Zefirus",
 ...
 "Leveche",
 "Mistral",
 "Norte", "Noreaster", "Norestero",
 "Norwester",
 "Noroestero",
 "Nortero",
 "Ostria",
 "Pali", "Santana",
 "Shamal", "Sharki", "Siroco", "Sumatra",
 "Tramontana",
 "Tifon", "Zefiros",
 "Zefiro",
 "Zefir",
 "Bora", "Etesian",
 "Levant", "Levante", "Leveche", "Harmatan",
 "Karaburan",
 "Buran", "Orosi", "Sarma", "Shamal", "Alisio",
 "Alize", "Bayamo",
 "Brisote",
 "Caju", "Nordeste",
 "Minuano",
 ...
 "Moe", "Myrsky", 		"Naseem",
 		"Neifion",
 		"Neil",
 "Neve", "Nigel", "Notus", "Payne", "Perun", "Firun", "Samir",
 "Sepher",
 "Shu", "Sky", "Stromur",
 "Sturm",
 "Thor", "Thunder",
 ...
 "Zephyr",
 "Zeus", "Aella", "Aethra",
 "Ahana", "Alize", "Amihan", "Anemos",
 "Anila", "Araceli",
 "Audra",
 "Aura", "Auretta",
 "Awen", "Azure", "Bonaria", "Ciela", "Cielo", "Dangira",
 "Dima", "Ekaitza",
 "Era", "Glaw", "Haizea", "Haneul",
 ...
 "Nuit", "Pilvi", "Puleng",
 "Rain", "Rakia", "Samira",
 "Sema", "Skye", "Stormy", "Tempest",
 "Tondra", "Varsha",
 "Vetra", "Zerua", "Zilan", "Mistral",
 "Gibli", "Zonda", "Etesian",
 "Shamal", "Aither",
 "Akash", "Alizeh", "Amphorn",
 "Amun", "Anan", "Anil", "Anore",
 "Anvindr",
 "Ayaz", "Bayu", "Boreas", "Caelus", "Corentin",
 "Enlil", "Erjon", "Ermir",
 "Esen", "Eyvinder",
 "Fujin", "Gokcan",
 ...
 "Auretta",
 "Azure", "Bonaria",
 "Breeze", "Brisa", "Ciela", "Coro", "Era",
 "Esen", "Eteri", "Haizea",
 "Haneul",
 "Ilma", "Kailani",
 "Kalani", "Lulani", "Makani",
 "Meltem",
 "Miku", 		"Mystral",
 		"Nasima",
 		"Ninlil",
 ...
 "Nura", "Wura", "Enarise",
 "Amana", "Aeana", "Akades",
 "Miste", "Zecori", "Sirocco",
 "Siroco",
 "Aura", "Zepherien",
 "Sior", "Annora",
 "Ael", 		"Arkansas",
 	"Anore", 		"Anil", 		"Anan", 		"Amun", 		"Akash", 		"Aeolus",
 		"Abel", 		"Autan", 		"Alize", 		"Alisio", 		"Aurora", 		"Abroholos",
 		"Auster", 		"Austru",
 		"Aerlyn",
 		"Aero", 		"Aelio",		"Aeolian",
 		"Brontes",
		"Baran", 		"Barak",		"Burle",		"Brisa",		"Brise",
		"Bise",		"Brisote",
		"Bayamo",
		"Buran",
		"Bora",		"Barat",		"Berber",
		...
		"Cers",		"Coromuel",
		"Cordonazo",
		"Caju",		"Cierzo",		"Contrastes",
		"Cordonazo",
		"Cyclone",
		"Chubasco",
		"Cave",		"Caelistis",
		"Esen",
	 "Erjon",		"Enlil",		"Euroclydon",
		"Etesian",		"Etesian",
		"Etesian",
		"Euros",		"Eolien",
		"Firun",
		...
		"Gale",			"Gale",
 		...
 		"Helm",		"Harmatan",
		"Hurricane",
	"Huracan",		"Haboob",		"Ilmara",
		"Keanu",
		"Kona",		"Kaver",		"Karaburan",
 		"Lodos",		"Leveche",		"Leveche",		"Levante",
		"Levant",		"Leste",		"Levanter",
		"Levante",		"Levantera",
		"Levanto",
		"Leveche",
		"Myrsky",
 	...
 	"Shamal", 		"Sarma", 		"Santana",
  	...
  	"Storm", 		"Torm", 		"Tufani",
 		...
 		"Amphorn",
 		"Amun", 		"Anan", 		"Anemos",
 		"Anil", 		"Anila", 		"Anore", 		"Anvindr",
 		"Araceli",
 		"Audra",
 		"Aura", 		"Auretta",
 		"Awen", 		"Ayaz", 		"Azure",
 		"Bayu", 		"Bonaria",
 		"Boreas",		"Caelus", 		"Cafeira",
 		"Ciela", 		"Cielo", 		"Corentin",
 		"Dangira",
 		"Dima", 		"Ekaitza",
 		"Enlil",
		"Era", 		"Erjon",		"Ermir",
	...
	"Amihan",		"Anila",
		...
		"Azure",		"Bonaria",
 		"Gibli",
		"Glaw", 		"Gokcan",
		"Govad",		"Guzrie",		"Haizea", 		"Haneul",		"Hayate", 		"Ilmari",
 		"Inanna",
		"Iris",		"Kafeira", 		"Keyne",
		"Minnesota",
 		"Mist",		"Mistral",
		"Misty",		"Naseem", 		"Nephele",
		"Neven", 		"Ninlil",
 		"Notus",
		"Nuit", 		"Ouranos",
 		"Payne",		"Pilvi", 		"Puleng",
...
Elementals = [
		"Zeruano",		"Exula",
		"Estix",
	"Stix",		"Lignan",		"Metallor",		"Astrelitz",		"Fulgarnis",		"Glacialyne",
		"Rayostrike",
		"Jaespirit",
		"Ombrosyl",
		"Element",
		...
		"Ombrosyl",
		"Element",		"Aetheria",
 "Agni", "Agnostos", "Alkeides", "Amphitrite",
	"Ananta",
 "Anemoi", "Aquaena",
 "Aranya",
 "Asura",	"Atlantea",
 ...
 "Hydros", "Ignatius",
 "Indra",	"Ixel", "Jadeite",
 "Kalki", "Khepri", "Kratos",	"Lavaea",
 "Levana",
 "Lykos",
 "Maia", "Marina",	"Mazu",
 "Medea", "Merapi", "Mnemosyne",
 "Nereus",	"Nyx", "Oceanus",
 "Ondine", "Ophion", "Orithyia",
	"Osiris",
 "Pallas", 		"Perseis",
 		"Phobos",
 		"Poseidia",
 ...
 "Skiron",
	"Styx",
 "Sula", "Surya", "Tefnut", "Thalassa",
	"Thalmos",
 "Theia", "Tlaloc", "Tridentis",
 "Typhon",	"Urania",
 "Varuna", "Vulcan",
 "Xipil", "Yamuna",	"Zephyra",
 "Zephyros",
 "Zinerva",
 "Zircon", "Zosimos",
	    "Aetheria",
 ...
 "Lykos",
 "Maia", "Marina",	    "Mazu",
 "Medea", "Merapi", "Mnemosyne", 	"Nereus",	    "Nyx", 			"Oceanus",
 		"Ondine", 		"Ophion", 		"Orithyia",
	    "Osiris",
 		"Pallas",
 	"Perseis",
 ...
 "Varuna", "Vulcan",
 "Xipil", "Yamuna",	    "Zephyra",
 "Zephyros", 	"Zinerva", 		"Zircon",
 		"Zosimos",
	    "Aetheria",
 	"Aegon", 		"Agni",
 		"Alkeides",
 	"Amara",	    "Amphitrite",
 	"Ananta", 	"Anemoi", 	"Aquaena", 		"Aranya",	    "Areion",
 		"Asura", 		"Astraea",
 		"Aura",
 		"Aurelian",
	    "Azura",
 	"Boreas",
 "Brontes",
 "Calida", "Calypso",	    "Celestia",
 "Chandra",
 "Chasca", "Chronos", "Clymene",
	    "Cyclopean",
 "Darya", "Demeter",
 "Dionysus",
 "Drakon",
...
def Names(genus):
	...
	if ATLANTIAN:
		Names += ["Kida",			"Milo",			"Helga",			"Gaetan",			"Audri",			"Vini",			"Nedak",			"Kashekim",			"Jeb",			"Presten",			"Joxua",			]
...
def Phonotactic(genus):
	...
	if True:
		if "Promethean" in genus:
			...
			fix += ["eth", "ath", "oth", 'erith', 'ex']
			sufx += ["ex", "us", "ar", 'um', 'on']

		if  "Salamandrian" in genus:
			prefx += [	"Blaz", 	"Inf",	"Flar"]
			fix += ["imdr",	 "amdr", "undr",	'endr', 'emdr',	'endr']
			sufx += ["us", "an", "el",	'no']

		if  "Titan" in genus:
			prefx += ["Gig", "Might", "Col"]
			fix += ["ant", "ent", "atn",'otn','atn']
			sufx += ["us", "an", "or"]

		if  "Uranians" in genus:
			prefx += ["Celest", "Astr", "Sky"]
			fix += ["in", "an", "on"]
			sufx += ["al", "um", "ion"]
	...
	if "Promethean" in genus:
			prefx += ["Flam", "Igni", "Volt", 'Amp', 'El']
			fix += ["ez", "am", "opr", 'epr', 'ectr']
			sufx += ["ex", "us", "ar", 'um', 'on']

	if  "Primordial" in genus:
			prefx += ["Prim", "Or", "El"]
			fix += ["ard", "erd", "ird",'ig','ord']
			sufx += ["us", "on", "ar",'nal',]
...
def Surphonotactic(genus):
	prefx = ["Atl", "Eos", "Cron", "Gen" , 'Gaian', 'Hyp', 'Ocean', 'Prim', 'Prom', 'Tundr', 'Chron', 'Gal', 'Eth', 'Tart', 'Zeph', 'Magm', 'Ur', 'Tit', 'Salam', 'Prom']
	fix = ["ant", "",  'us', 'as', '', 'er', 'ord', 'eth', 'ax', 'er', 'ar', 'ir', 'aforg', 'an', '', 'andr']
	sufx = ["ian", 'i', 'ie', 'ial', 'ean', 'an', 'an', 'ian']
