...
def Names(Type):
	...
	Names = [
		"Inkar", 	"Flinin", "Aztorm",	"Raven",	"Ax",		"Bramble",	"Akogre",	"Jale",		'Fende',	"Zorn",		    "Azkadow", 	"Ofrozt",	'Fendek',		"Blaze", 	"Riber",	"Uztone", 	"Askinud", 	"Falame",		'Ifrendek',	'Ofrenzek',	"Izkain", 				 	"Zexa",		"Ironok", 	"Mizet", 	"Nikat", 	"Likot", 	    "Fire",		    "Sanow", 	"Kulud", 	"Zalate",	'Onval',	'Ralig',		"Bexar", 	"Igale", 	"Zerepen", 	"Dragor",		"Sukax", "Ridje",	"Barac",	"Baracul",	"Aran",		"Forezat", 	"Bale",		"Zatar", 	"Mundar", 	"Zunar",		"Daxun", 	"Dusku", 	"Rafin",		"Otor",		'Juxalkar',		'Aran',		'Branag', 	'Kajel', 	'Dajel', 	'Exir',		'Fenderaz', 		'Jael', 	'Skarn', 	'Ivor',		'Akerven',		'Zoran',		'Kael', 	'Lorn', 	'Mel', 	'Norn',		'Orin', 	'Pyr', 		'Kin', 	'Rael',		'Kors',		'Zaron', 	'Tarn',		'Ulaf', 		'Voren', 	'Azkulof',		'Skan', 		'Yor', 		'Zorn', 	'Ardik',		'Jardi',	'Brek', 	'Zine', 	'Dorak',		'Eren', 		'Fayar',		'Jrim', 	'Holt', 	'Iknar', 	'Jarl',		'Ingos',		'Ken', 		'Lik', 		'Morn', 	'Naiyr',		'Oden',		'Puk', 	'Kurar', 	'Rune', 	'Syk',		'Akerar',		'Zor', 	'Ulric',	'Balk', 	'Skyrdi', 	'Skorn',		'Kranvi',	'Zygo', 	'Axender', 		'Blaze',		'Crux', 	'Dreng', 	'Eko', 	'Fang', 	'Jolak',	'Skask', 	'Jiron', 	'Jade',		'Juxalk', 	'Raifel',	'Kraken',	'Lexaf', 	'Mizot',  	'Naiyx',  	'Onayox',		'Pexak', 	'Kezt', 	'Rift', 	'Slate',		'Trove',	'Umbara', 	'Bex',  	'Azkinod', 	'Skile',		'Kole', 	'Zefir', 	'Ax', 		'Briar',		'Zinder', 	'Dune', 	'Ember', 	'Flint', 	'Jrove',	'Hexaz', 	'Isle', 	'Jasper',	'Kite', 	'Linox', 	'Mexadox', 	'Nectar', 	'Olive',	    'Pin', 	'Quartz', 	'Rid', 	'Azkale', 	'Ziket',	'Umber', 	'Bale', 	'Skilox',	'Skenon', 	'Karrox', 	'Zeniz',	'Torunrik',	'Ezkelax',		'Axaxel',	"Bewulf",	"Bowulf",	"Jarruk",	"Jarak", 	"Jarrek",  	'Marduk',        "Ark",		"Ardi",     "Skaldis", 	"Arn", 		"Asfrid",   "Azterix",	    "Axerod", 		"Akund",        "Skalrek",	"Skaldi",     "Atli",     "Bali",       "Borsak",     "Bali",    "Bjorn",        "Blod",     "Bulak",    "Brondar",  "Bragi", 	"Borik",	"Karguk",	"Darkfury",	"Drak",     "Erik",     "Erek",    	"Enk", 		"Erek", 	"Erik",		"Engli",   	"Exinar",  	"Zorga",        "Jelat",	"Jorigi",        "Jaro",        "Jrog",		"Junar",        "Skakon",   "Azkalvar",        "Zokaral",        "Jenk",        "Herdi",        "Holg",        "Hormac",        "Hosvir",		"Hosvir", 	"Idefix",        "Inge",        "Ingri",        "Ingrid",               "Ijuli",        "Iuli",        "Ivar",   	"Jarl",        "Zor",        "Zorko",        "Ketil",        "Oknute",        "Krex",        "Lagazi",  	"Leif",  	"Magnar",  	"Molsar",        "Molfizat",        "Merida", 	"Zorezorn",        "Ironlad",	"Molko",        "Obelix",  	"Odrok",        "Odin",		"Okil",        "Olof",                  "Olof",        "Ork",  	"Orom",        "Ormr",		"Osvif",        "Ovif",        "Ozerix",        "Panoramix",        "Rajeblade",		"Rajefury",        "Rajehon",   "Rajesog",        "Ragnar",        "Ragnara",		"Ragnarr",        "Ragnarra",		        "Rolof",	 	"Zagu",    	"Zarod",  	"Sigu", 	"Sigurd",  	"Azkarda",          "Azkarde",        "Skardi",        "Skej",        "Azkej",        "Ozku",        "Azkuf",        "Snorri",        "Zorli",		        "Zotej",        "Ozeinar",        "Zteinolf",        "Sva",        "Svafar",        "Svei",        "Azveik",        "Svein",        "Zunderaxe",        "Zunderblade",        "Zunderzot",        "Zundermol",        "Ulf",                        "Zrolak",   	"Zoral", 	            "Tofi",   	"Zorkel",  	"Zorald", 	"Zorlak",   "Trag", 	"Trarik",  	    "Tairfing",        "Torrad",        "Zrain",        "Tozte",        "Trayoj",        "Urd",        "Urda",        "Ulf",        "Ürd",        "Baljard",        "Bidar",        "Bifor",        "Bifil",        "Bikin",        "Skarkif",        "Azkarfag",           "Skarfizt",        "Agnor",        "Skadowrend",        "Sadaker",        "Azkarzorn",        	        "Zakah",        "Skar",    	"Skary",   	"Azkarmol",   "Yorak", 	"Korak",  	"Yorko",  	"Korko",  	"Yanovar",  "Azkarcax",	    "Marrowrend",  "Rolfuljar", "Skarbrexaker",		"Aldis",		"Aran",		"Asrid",		"Asterix",		"Axe",		"Agmund",		"Alrek",		"Baloli",		"Abjon",		"Oblod",		"Bulak",		"Carguk",		"Erek",		"Erik",		"Engli",		"Farkang",		"Gelek",		"Ognaros",		"Gorga",		"Ogrog",		"Grigi",		"Gorbo",		"Greiland",		"Henkar",		"Holgar",		"Hosvir",		"Idefix",		"Ingrid",		"Ajuli",		"Jorok",		"Lagazi",		"Merida",		"Ognorok",		"Obelix",		"Olof",		"Ovif",		"Ozerix",		"Panoramix",		"Ragnar",		"Sagu",		"Sarod",		"Azkeg",		"Azkarod",		"Azkuf",		"Azveik",		"Azvein",		"Safar",		"Azteinol",		"Azteg",		"Zorkel",		"Zoral",		"Torlak",		"Torag",		"Atrarik",		"Tirfin",		"Torrad",		"Ukro",		"Vifil",		"Brondar",		"Einar",		"Eyvind",		"Frode",		"Geirmundo",		"Guntar",		"Halvarda",		"Haralda",		"Inge",		"Ivar",		"Jarla",		"Ketil",		"Oknute",		"Leif",		"Magnar",				"Azkarde",
		"Snorri",		"Sorli",		"Azteinar",
		"Azrain",
		"Vidar",		"Yangar",		"Hakon",		"Bragi",		"Toste",
		]
	if FEMALE:
		Names += [
...
def Phonotactic(Type):
	...
	codas  = [""]
	onset +=  [
		"Ulf",  "Orm",  "Gor",  "As",   	"Bar",  	"Biorn",  "Brak", "Dagr",         "Eskol", "Em",   "Exir",  "Fol",  "Froz",  "Zorm", "Jrom",        "Jun",  "Junk", "Skald", "Skalv", "Herj", "In", "Ink", 		"Jarl", "Zol",  "Zol",  "Jot",  "Knut", "Kael",		"Lot",  'Luc',  "Orc",  "Ork",  "Ormr", "Iskol",  "Ing",        "Ragn", "Rag",  "Rolf", "Zor",  "Tud",  "Tor",  "Is",        "Urg",  "Ug", "Ul", "Ulf",  "Zun",  "Zunk", "Zurd",        "Barg", "Balk", "Big",  "Skulf", "Y",  "Konv",		'Urf', 	"Urg", "Urj", 		"Azk",	"Yaj",	"Konx",		"Ask",	"Bakr",	"Biork", "Dak",	"Esm",	"Emr",		"Er", "Ir", "Ur", "Hild",

			]
	nuclei += [
	"ulj",  "ar",   "aiv",   "an", "ain",  "al",   "ak",     "aik", 	"ar", "air", "as","en", "el", "es", "ek", "ir", "ar",	"ir", "in", "il", "ik", "is","ol", "or", "ork", "al", 	"ag", "ag", "urg", "uarg","ir", "or", "on", "ok", "ol", "os",	 "av", "ol", "ig", "ug", "rem","ur", "un", "uk", "ul", "us",	 "arm", "avin",	"anon", "axin", "axon", "aror", "azor", 	 "aroz", "oruz", "olv",  "ulv", "ilb", "orj",  "im",	 "arik", "aizt", "ezt", "alv", "alw", "ulv", "ol", "is",
	  ]
	codas +=  [
...
def Surphonotactic(Type):
	...
	onset +=   [
		"Ax",
		'Balk',		"Blade", 	"Blod",		"Bonz",		"Bexar",		"Bon",
		"Dar", 	"Dark",
		"Elk",		"Igle",
	...
	codas +=   [
		"on","ul",		"akel",		"alor",		"akor",		"azon",		 "alok",		'uk',		"ejard", "uvold", "oberg",		"afire", 	"edot", 	"uhild", "ijorn", "omund",		"arond", 	"eztein", 	"uztor", "ulf",		"exar", 	"uhorn", 	"ihurt", "ojok", 			"ekel", 	"uker", 		"ikin", 	"okon",		"ekun", 		"ulok", 	"ilom", 	"olon",		 	"elun",		'ubarg',		"ur",		"und","eson",  	"ujar",	"ivar",	"ovik",	"ovind", 	"alaf", 	"elif", 	"fang",		"isig", 	"ozor",  "emark", "ulof",	"unir", 	"inur", 		"orik", 	"arok", 	"erul", "uskar", 	"iskul", 	"otar", 	"ator", 	"etur","uvik", 	"ivol", 		"ovul", 	"agorn", "ejrin", "ugund", 	"ihak", 		"ojal", 	"ajan",	"ulyif",
