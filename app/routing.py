"""routing — temporarily loaded from vaulted bytecode (recovery 2026-08-29)."""
...
_PYC = Path(__file__).resolve().parents[1] / ".recovery-vault" / "app" / "routing.cpython-314.pyc"

_body_name = "app._bc_routing"
