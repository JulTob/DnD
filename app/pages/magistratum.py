"""magistratum — temporarily loaded from vaulted bytecode (recovery 2026-08-29)."""
...
_PYC = Path(__file__).resolve().parents[2] / ".recovery-vault" / "app/pages" / "magistratum.cpython-314.pyc"

_body_name = "app.pages._bc_magistratum"
