"""alusoris_list — temporarily loaded from vaulted bytecode (recovery 2026-08-29)."""
...
_PYC = Path(__file__).resolve().parents[3] / ".recovery-vault" / "app/pages/actor_ludi" / "alusoris_list.cpython-314.pyc"

_body_name = "app.pages.actor_ludi._bc_alusoris_list"
