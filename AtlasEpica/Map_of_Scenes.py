"""Map_of_Scenes — temporarily loaded from vaulted bytecode (recovery 2026-08-29)."""
...
_PYC = Path(__file__).resolve().parents[1] / ".recovery-vault" / "AtlasEpica" / "Map_of_Scenes.cpython-314.pyc"

_body_name = "AtlasEpica._bc_Map_of_Scenes"
