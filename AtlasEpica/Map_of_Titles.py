...
'''
	...
	try:
		...
		descriptor += [
			"Knowledge", "Keep", "Krakenesque", "Knife",
			"Kaleidoscopic", "Keen", "Key", "Kind",
			"Kingly", "Knightly", "Kerberus", "Key",
			]
		descriptor += [
	...
	if "Construct" in genus:
		descriptor += [
			"Electrostatic", "Puppeteer", "Clockwork",
			"Living", "Titanium", "Iron",
			"Steel", "Palladium",
			]
	if "Dwarf" in genus:
		descriptor += [
	...
	if "Beholder" in genus:
		descriptor += [
			"All Seeing", "Beholder", "Omniscient",
			"Paranoid", "Tyrannical",
			"Unblinking", "Visionary",
			]
	if "Old One" in genus:
		descriptor += [
			"Ancient",
	...
	if "Ghost" in genus:
		descriptor += [
			"Ethereal", "Mournful", "Pain",
			"Sorrow", "Unresolved",
			"Urn", "Unholy",
			]
	if "Catfolk" in genus:
		descriptor += [
			"Agile", "Amber", "Cat", "Claw",
			"Feline", "Mammalian", "Mystical", "Prowler",
			"Shadow", "Stealthy", "Whiskered", "Whiskers",
			]
	if "Centaur" in genus:
		descriptor += [
			"Centaur",
	...
	if "Fiend" in genus:
		descriptor += [
			"Amber", "Caustic", "Contaminated", "Dark", "Demon",
			"Demonic", "Diabolical", "Fiendish", "Hell", "Infernal",
			"Liar", "Malevolent", "Red", "Sinister", "Unholy",
			]
	if "Owl" in genus:
		descriptor += [
			"All Seeing", "Mystic", "Mystical", "Night",
			"Nocturnal", "Omniscient", "Silent",
			"Silentwing", "Wisdom", "Wise",
			]
	if "Kitsune" in genus:
		descriptor += [
			"Nine Tales", "Amber", "Masked", "Astral", "Blue", "Blue", "Cunning",
			"Enchanted", "Enchanter", "Enchanting", "Fox", "Foxfire", "Foxy",
			"Golden", "Illusion", "Illusory", "Mystic", "Mystical", "Nine Tailed", "Nine Tailed",
			"Red", "Tailed", "Tale", "Trickster", "Trickster", "Yellow",
			]
	if "Lion" in genus or "Leon" in genus:
		descriptor += [
			"Amber", "Brave", "Exalted", "Gold", "Golden", "Golden",
			"Lion", "Majestic", "Mammalian", "Pride", "Pride",
			"Regal", "Roaring", "Sun", "Sunlit", "Yellow",
			]
	if "Mage" in genus:
		descriptor += [
			"Arcane", "Arcane", "Black", "Blue", "Crimson", "Enigmatic",
			"Golden", "Green", "Grey", "Learned", "Mystical", "Rainbow",
			"Red", "Scholar", "Sorcerous", "Spellbinder", "White", "Yellow",
			]
	if "Ooze" in genus:
		descriptor += [
			"Absorbing",
...
'''
	...
	if "Noble" in genus:
		...
		if MALE:
			...
			rank += [
				"Baroness", "Lady", "Baroness", "Queen", "Princess", "Princess", "Princess", "Baroness", "Queen", "Lady",
				"Overlady", "Queen", "Archduchess", "Baroness", "Duchess", "Empress", "Empress", "Highlady", "Lady", "Lady",
				"Lady", "Princess", "Queen", "Queen", "Queen", "Queen", "Queen", "Viscountess", "Warlady",
				]
		else:
			rank += [
				"Ruler", "Potentate",
